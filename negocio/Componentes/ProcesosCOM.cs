...
namespace negocio.Componentes
{
    public class ProcesosCOM
    {
        ...
        public DataSet ManualesPendientesxAutorizar(ProcesosENT entidad)
        {
            DataSet ds = new DataSet();
            List<SqlParameter> listparameters = new List<SqlParameter>();
            Datos data = new Datos();
            try
            {
                ds = data.enviar("sp_catalogo_procesosborr_pendientes", listparameters, false);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet AgregarSubProcesosProduccion(ProcesosENT entidad)
        {
            DataSet ds = new DataSet();
            List<SqlParameter> listparameters = new List<SqlParameter>();
            Datos data = new Datos();
            ...
            try
            {
                ds = data.enviar("sp_a_subprocesos", listparameters, true);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet ProduccionaBorrador(ProcesosENT entidad)
        {
            DataSet ds = new DataSet();
            List<SqlParameter> listparameters = new List<SqlParameter>();
            Datos data = new Datos();
            listparameters.Add(new SqlParameter() { ParameterName = "@PIDC_PROCESO", SqlDbType = SqlDbType.Int, Value = entidad.Pidc_proceso });
            listparameters.Add(new SqlParameter() { ParameterName = "@PDESCRIPCION_NUEVO", SqlDbType = SqlDbType.Int, Value = entidad.Pdescripcion });
            listparameters.Add(new SqlParameter() { ParameterName = "@pidc_usuario", SqlDbType = SqlDbType.Int, Value = entidad.Idc_usuario });
            listparameters.Add(new SqlParameter() { ParameterName = "@pdirecip", SqlDbType = SqlDbType.VarChar, Value = entidad.Pdirecip });
            listparameters.Add(new SqlParameter() { ParameterName = "@pnombrepc", SqlDbType = SqlDbType.VarChar, Value = entidad.Pnombrepc });
            listparameters.Add(new SqlParameter() { ParameterName = "@pusuariopc", SqlDbType = SqlDbType.VarChar, Value = entidad.Pusuariopc });
            try
            {
                ds = data.enviar("sp_proceso_produccion_a_borrador", listparameters, true);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet BorradorBorrador(ProcesosENT entidad)
        {
            DataSet ds = new DataSet();
            List<SqlParameter> listparameters = new List<SqlParameter>();
            Datos data = new Datos();
            ...
            try
            {
                ds = data.enviar("sp_proceso_borrador_a_borrador", listparameters, true);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet CancelarSolicitud(ProcesosENT entidad)
        {
            ...
            try
            {
                ds = data.enviar("sp_e_solicitudaprobacion_procesos", listparameters, true);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataSet SolictarProcesos(ProcesosENT entidad)
        {
            ...
            try
            {
                ds = data.enviar("sp_solictar_manual_procesos", listparameters, true);
            }
            catch (Exception ex)
            {
                throw ex;
