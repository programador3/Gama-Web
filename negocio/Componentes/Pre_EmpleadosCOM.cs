...
namespace negocio.Componentes
{
    public class Pre_EmpleadosCOM
    {
        ...
        public DataSet GuardarPreEmpleas(Pre_EmpleadosENT Entidad)
        {
            ...
            listparameters.Add(new SqlParameter() { ParameterName = "@idc_edocivil", SqlDbType = SqlDbType.TinyInt, Value = Entidad.Idc_edocivil });
            listparameters.Add(new SqlParameter() { ParameterName = "@idc_estado", SqlDbType = SqlDbType.Int, Value = Entidad.Idc_estado });
            ...
            listparameters.Add(new SqlParameter() { ParameterName = "@idc_colonia", SqlDbType = SqlDbType.Int, Value = Entidad.Idc_colonia });
