    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
        ...
        <ContentTemplate>
            <div align="center" class="ui-header ui-bar-a" style="width: 100%; margin-bottom: 20px;">
                <asp:Label ID="lblheader" runat="server" Text="Pedidos"
            ...
            <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtbuscar" runat="server" AutoCompleteType="FirstName"
                                        ...
                                        CssClass="form-control2 txt_search" OnTextChanged="txtbuscar_TextChanged"></asp:TextBox>
                                    ...
                                    <asp:Button ID="btnbuscarcliente" runat="server" Font-Bold="True" Style="display: none;" CssClass="btn btn-default"
                                        ForeColor="Black" Height="35px" Text="Buscar" Width="100%" OnClick="btnbuscarcliente_Click" />
                                </td>
                            </tr>
                        </table>
                        <table style="width: 100%">
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnacep_bus" runat="server" Font-Bold="True" ForeColor="Black"
                                        ...
                                        Font-Names="arial" Font-Size="Small" OnClick="btnacep_bus_Click" />
                                ...
                                <td>
                                    ...
                                    <asp:Button ID="btncan_bus" runat="server" Font-Bold="True" ForeColor="Black"
                                        ...
                                        CssClass="btn btn-default"
                                        Font-Size="Small" OnClick="btncan_bus_Click" />
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtcve" runat="server"
                                        CssClass="form-control2" onfocus="this.blur();"
                                        Height="30px" ReadOnly="True" Width="28%" Font-Names="arial" Style="display: inline !important;"
                            ...
                            <tr>
                                <td style="width: 50%">
                                    <div id="Div2" class="styled-select" style="width: 100%;">
                                        <asp:DropDownList ID="cboentrega" runat="server" CssClass="form-control" AutoPostBack="true"
                                            Font-Bold="True" ForeColor="Black" Height="35px" onchange="cboentrega(this);"
                                            Width="100%" OnSelectedIndexChanged="cboentrega_SelectedIndexChanged">
                                            <asp:ListItem Value="1">Entregamos</asp:ListItem>
                                            <%--<asp:ListItem Value="2">Entrega Proveedor</asp:ListItem>--%>
                                            <asp:ListItem Value="3">Recoge Cliente</asp:ListItem>
                                            <%--<asp:ListItem Value="4">Anticipos</asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <td>
                                    <asp:Button ID="btnconsignado" runat="server" Font-Bold="True"
                                        ForeColor="Black" Height="35px" Text="Consignado" Width="100%"
                                        CssClass="btn btn-default"
                            ...
                            <tr>
                                <td style="width: 50%">
                                    ...
                                    <asp:Button ID="btncaptArt" runat="server" Font-Bold="True" Font-Size="Small" OnClientClick="mostrar_procesar();"
                                        ForeColor="Black" Height="35px" Text="Capturar Articulos" Width="100%"
                                        CssClass="btn btn-default" OnClick="btncaptArt_Click" />

                                </td>
                                <td style="width: 50%">
                                    <asp:Button ID="btnOC" runat="server" Enabled="False" Font-Bold="True"
                                        ForeColor="Black" Height="35px" Text="OC Pendientes" Width="100%"
                                        CssClass="btn btn-default"
                                        Font-Size="Small" />
                                </td>
                            </tr>
                ...
                <tr>
                    <td>
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 100%">
                                    <asp:TextBox ID="txtcodigoarticulo" runat="server" AutoCompleteType="Search" AutoPostBack="true"
                                        CssClass="form-control2" Enabled="False" placeholder="Buscar Articulo"
                                        Width="100%" OnTextChanged="txtcodigoarticulo_TextChanged"></asp:TextBox>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btn_seleccionar_master" runat="server"
                                        ...
                                        Height="35px" Text="Seleccionar" Visible="False" Width="100%" OnClick="btn_seleccionar_master_Click1" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Button ID="btnmaster" runat="server"
                                        CssClass="btn btn-default"
                                        Font-Bold="true" Font-Names="arial" Font-Size="Small" ForeColor="Black"
                                        Height="35px" Text="Master" Visible="False" Width="100%" OnClick="btnmaster_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Button ID="btnbuscar_codigo" runat="server"
                                        CssClass="btn btn-default"
                                        Font-Bold="true" Font-Names="arial" Font-Size="Small" ForeColor="Black"
                                        Height="35px" Text="Buscar" Visible="False" Width="100%" OnClick="btnbuscar_codigo_Click1" />
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
                ...
                <tr>
                    <td>
                        ...
                        <asp:DataGrid ID="grdproductos2" runat="server" AutoGenerateColumns="False" Style="font-size: 11px;"
                            CssClass="table table-responsive table-bordered table-condensed" OnEditCommand="grdproductos2_EditCommand"
                            OnItemCommand="grdproductos2_ItemCommand" OnItemDataBound="grdproductos2_ItemDataBound">
                                ...
                                <asp:TemplateColumn HeaderText="Precio">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtpreciogrid" runat="server" ForeColor="Black" Height="20px"
                                            onkeydown="return x(event)"
                                            Text='<%# DataBinder.Eval(Container, "DataItem.Precio","{0:N4}") %>'
                                            Width="60px"></asp:TextBox>

                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblprecio" runat="server" Text='<%# Eval("precio","{0:N4}") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle CssClass="Ocultar" />
                                    <HeaderStyle CssClass="Ocultar" />
                                </asp:TemplateColumn>
                                ...
                                <asp:TemplateColumn HeaderText="Precio Real">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="precioreal" runat="server"
                                            Text='<%# Eval("precioreal","{0:N4}") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                ...
                <tr>
                    <td>
                        <table style=" border: 1px solid gray; background-color:white; width: 100%;">
                            <tr>

                                <td align="center" style="width: 100%"><i class="fa fa-money" aria-hidden="true"></i>
                                    <asp:Label ID="Label16" runat="server" Font-Bold="True" style="font-size:15px"
                            ...
                            <tr>
                                ...
                                <td align="center"
                                    ...
                                    <label style="width:8%;"><strong><i class="fa fa-usd" aria-hidden="true"></i></strong></label>
                                    <asp:TextBox ID="txtpretotal" runat="server" CssClass="form-control2"
                                        Enabled="False" Height="30px" Width="85%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="center"
                                    ...
                                    <asp:TextBox ID="txttotaldescuento" runat="server" CssClass="form-control2"
                                        Enabled="False" ForeColor="Red" Height="30px" Width="85%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="border-color: #FFFFFF #808080 #FFFFFF #808080; width: 25%; text-align:right;">
                                    <asp:Label ID="labeliva" runat="server" Font-Bold="True" Font-Names="arial"
                                        Font-Size="Small" ForeColor="Orangered" Text="IVA:"></asp:Label>
                                </td>
                            </tr>
                        </table>
                        <br />
                            ...
                            <tr>
                                ...
                                <td style="width: 50%">
                                    <asp:Button ID="btnverOc" runat="server" Font-Bold="True" ForeColor="Black"
                                        Height="35px" Text="Ver OC" Width="100%"
                                        CssClass="btn btn-default" />
                                </td>
                            </tr>
                        </table>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 38.5%">
                                                <asp:Button ID="btnquitarll" runat="server" Font-Bold="True" ForeColor="Black"
                                                    ...
                                                    CssClass="btn btn-default" OnClick="btnquitarll_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btncambiarcroquis" runat="server" Font-Bold="True"
                                                    ...
                                                    Width="100%"
                                                    CssClass="btn btn-default" OnClick="btncambiarcroquis_Click" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btncargarflete" runat="server" Text="Cargar Flete"
                            CssClass="Ocultar" OnClick="btncargarflete_Click" />
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:Button ID="btnagregar" runat="server" CssClass="Ocultar" Enabled="False"
                                        Font-Bold="True" ForeColor="Black" Height="" Text="Agregar" OnClick="btnagregar_Click" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="center">
                                    <asp:Button ID="btncancelararticulo" runat="server" CssClass="Ocultar"
                                        ...
                                        Text="Cancelar" OnClick="btncancelararticulo_Click" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <asp:Button ID="btnref" runat="server" CssClass="Ocultar" Height=""
                            Text="ref" Width="" OnClick="btnref_Click" />
                        <asp:Button ID="btneditar_art" runat="server" CssClass="Ocultar" OnClick="btneditar_art_Click" />
                        <asp:TextBox ID="txtidc_articulo" runat="server" CssClass="Ocultar">
                        </asp:TextBox>
                        <asp:Button ID="btnref_especif" runat="server" CssClass="Ocultar" OnClick="btnref_especif_Click" />
                        ...
                        <asp:Button ID="btnbuscarart" runat="server" CssClass="Ocultar" Height=""
                            Text="buscar" Width="" OnClick="btnbuscarart_Click" />
                        <asp:Button ID="btnredirecting" runat="server" CssClass="Ocultar" Text="red" OnClick="btnredirecting_Click" />
                        ...
                        <asp:Button ID="btnvalidaChP" runat="server" CssClass="Ocultar"
                            ForeColor="White" Height="" Text="ChekP" Width="" OnClick="btnvalidaChP_Click" />
                        <asp:Button ID="btnagregarllamada" runat="server" CssClass="Ocultar"
                            ForeColor="White" Height="" Text="AgregarLl" Width="" OnClick="btnagregarllamada_Click" />
                        ...
                        <asp:Button ID="btnagregarcroquis" runat="server" CssClass=" Ocultar"
                            ForeColor="White" Height="" Text="AgregarCroquis" Width="" OnClick="btnagregarcroquis_Click" />
                        ...
                        <asp:Button ID="btncalc_iva" runat="server" CssClass="Ocultar" Height=""
                            Text="Calcular_Iva" Width="" OnClick="btncalc_iva_Click" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:ImageButton ID="btnbuscarcol" runat="server" Height="21px"
                                                                ...
                                                                Style="margin-left: 0px" Width="" OnClick="btnbuscarcol_Click" />
                                                        </td>
                                                        <td align="right">
