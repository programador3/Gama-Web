<%@ Page Title="" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="entregas.aspx.cs" Inherits="presentacion.entregas" %>
                        ...
                        <ItemTemplate>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <asp:Panel ID="PanelRevisionP" runat="server" class="small-box bg-green">
                                    ...
                                    <asp:LinkButton ID="lnkGO" runat="server" CssClass="small-box-footer" OnClick="lnkIcon_Click">Comenzar Entrega <i class="fa fa-arrow-circle-o-right"></i></asp:LinkButton>
                                </asp:Panel>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
