<%@ Page Title="Administrador Entregas" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="administrador_entregas.aspx.cs" Inherits="presentacion.administrador_entregas" %>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <asp:Panel ID="PanelPrebajas" runat="server">
                <h2 id="Noempleados" runat="server" visible="false" style="text-align: center;">No hay Entregas Activas <i class="fa fa-exclamation-triangle"></i></h2>
                <asp:Repeater ID="repeatprebajas" runat="server" OnItemDataBound="repeatprebajas_ItemDataBound">
                    <ItemTemplate>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <asp:Panel ID="PanelRevisionP" runat="server" class="small-box bg-red">
                                <div class="inner">
                                    <h4>Entregas Pendiente
                                    </h4>
                                    <p>
                                        <h6>
            ...
            <asp:Panel ID="PanelDetalles" runat="server" Visible="false">
                <div class="row">
                    <div class="col-lg-10" style="margin: 0 auto;">
                        <h4><strong>Datos del Empleado en Proceso de Entrega</strong>
                            <asp:LinkButton ID="lnklista" runat="server" class="btn btn-primary" OnClick="lnklista_Click" Visible="false">Ver Lista de Entregas <i class="fa fa-list"></i></asp:LinkButton>
                        </h4>
                    </div>
                    <div class="col-lg-2">
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12" style="text-align: left">
                        <div class="form-group">
                            <h4><strong>Nombre Empleado: </strong>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <h4><i class="fa fa-spinner"></i>Progreso de las Entregas actualizado a
                        ...
                        <asp:UpdatePanel ID="UpdatePanel" runat="server" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                <div class="table table-responsive">
                                    ...
                                    <asp:GridView ID="gridprebajasdetalles" runat="server" CssClass="table table-bordered table-hover table-condensed" AutoGenerateColumns="False" DataKeyNames="idc_entrega,puesto,tipo_prep,empleado,descripcion, idc_puestoprebaja,idc_puesto,fecha_revision" OnRowCommand="gridprebajasdetalles_RowCommand" OnRowDataBound="gridprebajasdetalles_RowDataBound" Font-Size="Smaller">
                                        <Columns>
                                            <asp:ButtonField ButtonType="Image" ImageUrl="~/imagenes/btn/more.png" HeaderText="Ver" CommandName="Ver">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:ButtonField>
                                            <asp:BoundField DataField="idc_entrega" HeaderText="idc_entrega" Visible="False"></asp:BoundField>
