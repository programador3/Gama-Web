...
{
    public partial class revisiones_servicios_captura : System.Web.UI.Page
    {
        ...
        protected void ddlTipoRev_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlTipoRev.SelectedValue == "0") { lblrrortiporev.Visible = true; }
            else
            {
        ...
        protected void ddlTipoaplicacion_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlTipoaplicacion.SelectedValue == "0") { ddltipoaplica.Visible = true; }
            else
            {
        ...
        public void CargaGridEdicion()
        {
            ...
            entidad.Pidc_revisionser = Convert.ToInt32(Session["idc_revisionser_edit"].ToString());
            DataSet ds = componente.CargaServiciosEditar(entidad);
            ...
            string tipo_rev = ds.Tables[0].Rows[0]["tipo"].ToString();
            string revisa = ds.Tables[0].Rows[0]["idc_puesto"].ToString();
            string desc = ds.Tables[0].Rows[0]["descripcion"].ToString();
            bool final = Convert.ToBoolean(ds.Tables[0].Rows[0]["final"]);
            bool vales = Convert.ToBoolean(ds.Tables[0].Rows[0]["generar_vales"]);
            cbxGenraVales.Checked = vales;
            cbxFinal.Checked = final;
        ...
        protected void Yes_Click(object sender, EventArgs e)
        {
            ...
            entidad.Final = cbxFinal.Checked;
            entidad.Genera_Vales = cbxGenraVales.Checked;
            DataSet ds = new DataSet();
            switch (Confirma_a)
            {
                case "Cancelar":
                    Response.Redirect("catalogo_revisiones_servicios.aspx");
                    break;
            ...
            if (mensaje == "")//no hay errores retornamos true
            {
                ...
                dtp.Columns.Add("idc_puesto_gpo");
                Session["tabla_grupos"] = dtp;
                ScriptManager.RegisterStartupScript(this, GetType(), "GOALERT", "AlertGO('La Asignación fue realizada correctamente.','catalogo_revisiones_servicios.aspx');", true);
            }
            else
            {//mostramos error
        ...
        public new bool Error()
        {
            ...
            if (txtDescripcion.Text == "") { error = true; lblDescripcion.Visible = true; }
            lblrrortiporev.Visible = false;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (Session["value_tipo_apli"] == null || PanelComboTipoApli.Visible == false) { Session["value_tipo_apli"] = "T"; }
        ...
        {
            if (cbxFinal.Checked == true) { cbxFinal.Checked = false; }
            else { cbxFinal.Checked = true; }
        }

        protected void lnkGenraVales_Click(object sender, EventArgs e)
        {
            if (cbxGenraVales.Checked == true) { cbxGenraVales.Checked = false; }
            else { cbxGenraVales.Checked = true; }
        }
    }
}