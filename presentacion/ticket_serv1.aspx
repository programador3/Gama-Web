<%@ Page Title="Ticket de Servicios" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="ticket_serv1.aspx.cs" Inherits="presentacion.ticket_serv1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <h2 class="page-header"><i class="fa fa-bookmark-o" aria-hidden="true"></i>&nbsp; Ticket de Servicios</h2>
