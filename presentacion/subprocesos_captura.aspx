                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <asp:TextBox ID="txtdescproceso" CssClass="form-control" TextMode="MultiLine" Rows="4" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <asp:LinkButton ID="lnkaddfile" CssClass="btn btn-info btn-block" OnClick="lnkaddfile_Click" runat="server">Agregar Archivo  <i class="fa fa-plus-circle" aria-hidden="true"></i></asp:LinkButton>
                            <br />
                ...
                <ContentTemplate>
                    <div class="panel panel-info fresh-color">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4><strong><i class="fa fa-retweet" aria-hidden="true"></i>&nbsp;Perfiles Relacionados al SubProceso</strong><small> Seleccione los perfiles</small></h4>
                                    <div style="height: 200px; overflow: scroll;">
                                        <asp:CheckBoxList ID="cbxlperfiles" CssClass="list-group" runat="server"></asp:CheckBoxList>
                                    </div>

                                    <asp:LinkButton ID="lnkagregar" CssClass="btn btn-success btn-block" OnClick="lnkagregar_Click" runat="server">Agregar <i class="fa fa-plus-circle" aria-hidden="true"></i></asp:LinkButton>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
