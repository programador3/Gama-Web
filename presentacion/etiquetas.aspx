                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <asp:Button ID="btnAgregarOpcion" runat="server" class="btn btn-info" Text="Agregar" OnClick="btnAgregarOpcion_Click" />
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="gridOpciones" EventName="RowDeleting" />
                                    </Triggers>
                                    <ContentTemplate>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="table-responsive">
                                                        ...
                                                        <asp:GridView ID="gridOpciones" runat="server" class="table table-condensed table-bordered table-hover table table-striped" OnRowDeleting="gridOpciones_RowDeleting" AutoGenerateColumns="False">
                                                            <Columns>
                                                                <asp:BoundField DataField="idc_perfiletiq_opc" HeaderText="ID" SortExpression="idc_perfiletiq_opc" Visible="False" />
                                                                <asp:ButtonField ButtonType="Image" CommandName="Delete" HeaderText="Borrar" ShowHeader="True" Text="Borrar" ImageUrl="~/imagenes/btn/icon_delete.png" />
