...
{
    public partial class html_dinamico : System.Web.UI.Page
    {
...
<li>Item 2</li>
        ...
        private void AddPapeleriaToTableEtiquetas(string url, string descripcion, int idc_subproceso)
        {
            DataTable dt = (DataTable)Session[lblsession.Text + "table_subprocesos"];
            ...
            Session[lblsession.Text + "table_subprocesos"] = dt;
        }
