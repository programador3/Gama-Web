<%@ Page Title="" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="tareas_listado_sub.aspx.cs" Inherits="presentacion.tareas_listado_sub" %>
                        ...
                        <div class="card-header" style="background-color: #22A7F0; color: white;">
                            <div class="card-title" style="background-color: #22A7F0; color: white;">
                                <div class="title" style="background-color: #22A7F0; color: white;">
                                    <h3 style="background-color: #22A7F0; color: white;">Tareas de Mis Subordinados<small style="background-color: #22A7F0; color: white;" id="total_tareas" runat="server">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="list-group">
                                        ...
                                        <asp:Repeater ID="repeat_tareas" runat="server">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnktarea" PostBackUrl='<%#Eval("url").ToString()+presentacion.funciones.deTextoa64(Eval("idc_tarea").ToString())+"&lectura=1"%>' runat="server" CssClass='<%#Eval("css_class")%>' ToolTip='<%#Eval("desc_completa")%>'>
                                                    ...
                                                    <p class="list-group-item-text"><strong>Asigna</strong>: <%#Eval("empleado_asigna")%></p>
