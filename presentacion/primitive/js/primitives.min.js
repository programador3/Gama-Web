...
jQuery.widget("ui.mouse2", {
    version: "1.10.1", options: { cancel: "input,textarea,button,select,option", distance: 1, delay: 0 }, _mouseInit: function (a) { var b = this; this.element2 = a; this.element2.bind("mousedown." + this.widgetName, function (a) { return b._mouseDown(a) }).bind("click." + this.widgetName, function (a) { if (!0 === jQuery.data(a.target, b.widgetName + ".preventClickEvent")) return jQuery.removeData(a.target, b.widgetName + ".preventClickEvent"), a.stopImmediatePropagation(), !1 }); this.started = !1 }, _mouseDestroy: function () {
        ...
        if (!mouseHandled2) {
            this._mouseStarted && this._mouseUp(a); this._mouseDownEvent = a; var b = this, c = 1 === a.which, d = "string" === typeof this.options.cancel && a.target.nodeName ? jQuery(a.target).closest(this.options.cancel).length : !1; if (!c || d || !this._mouseCapture(a)) return !0; this.mouseDelayMet = !this.options.delay;
            ...
            jQuery(document).bind("mousemove." + this.widgetName, this._mouseMoveDelegate).bind("mouseup." + this.widgetName, this._mouseUpDelegate); a.preventDefault(); return mouseHandled2 = !0
        }
    }, _mouseMove: function (a) {
        if (jQuery.ui.ie && (!document.documentMode || 9 > document.documentMode) && !a.button) return this._mouseUp(a); if (this._mouseStarted) return this._mouseDrag(a), a.preventDefault(); this._mouseDistanceMet(a) && this._mouseDelayMet(a) && ((this._mouseStarted = !1 !== this._mouseStart(this._mouseDownEvent, a)) ? this._mouseDrag(a) :
        this._mouseUp(a)); return !this._mouseStarted
    }, _mouseUp: function (a) { jQuery(document).unbind("mousemove." + this.widgetName, this._mouseMoveDelegate).unbind("mouseup." + this.widgetName, this._mouseUpDelegate); this._mouseStarted && (this._mouseStarted = !1, a.target === this._mouseDownEvent.target && jQuery.data(a.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(a)); return !1 }, _mouseDistanceMet: function (a) {
...
primitives.common.BaseShape.prototype._getLabelPosition = function (a, b, c, d, e, f, g, h) {
    var j = null; switch (h) {
        case 1: j = new primitives.common.Rect(a + c / 2 - e / 2, b - g - f, e, f); break; case 2: j = new primitives.common.Rect(a + c - e, b - g - f, e, f); break; case 8: j = new primitives.common.Rect(a, b - g - f, e, f); break; case 3: j = new primitives.common.Rect(a + c + g, b + d / 2 - f / 2, e, f); break; case 11: j = new primitives.common.Rect(a + c + g, b, e, f); break; case 12: j = new primitives.common.Rect(a + c + g, b + d - f, e, f); break; case 4: j = new primitives.common.Rect(a + c - e,
        b + d + g, e, f); break; case 6: j = new primitives.common.Rect(a, b + d + g, e, f); break; case 7: j = new primitives.common.Rect(a - e - g, b + d / 2 - f / 2, e, f); break; case 9: j = new primitives.common.Rect(a - e - g, b, e, f); break; case 10: j = new primitives.common.Rect(a - e - g, b + d - f, e, f); break; default: j = new primitives.common.Rect(a + c / 2 - e / 2, b + d + g, e, f)
    } return j
...
primitives.common.Connector.prototype.draw = function (a, b, c) {
    ...
    e.x, f.height < f.width) {
        f.height < 2 * m && f.offset(0, l ? 2 * m : 0, 0, l ? 0 : 2 * m); g = 0; for (h = j.length; g < h; g += 1) i = j[g], u.addInverted(function (a) { a = a.getPolyline(t); a.addSegment(new primitives.common.MoveSegment(d.x, d.y + i)); a.addSegment(new primitives.common.QuadraticArcSegment(f.horizontalCenter(), (l ? f.top() : f.bottom()) + i, e.x, e.y + i)) }, !g), v.addArrow(this.lineWidth, function (a) { a.mergeTo(u.getPolyline(a.paletteItem)) }); j = n.width < 2 * (f.width / 5) ? primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x, d.y, f.horizontalCenter(),
        l ? f.top() : f.bottom(), e.x, e.y, 0.5) : new primitives.common.Point(d.x, l ? f.top() : f.bottom()); p = new primitives.common.Rect(j.x + (k ? m : -n.width - m), l ? j.y - n.height - m : j.y + m, n.width, n.height)
    } else {
        g = 0; for (h = j.length; g < h; g += 1) i = j[g], u.addInverted(function (a) {
            a = a.getPolyline(t); a.addSegment(new primitives.common.MoveSegment(d.x, d.y + i)); a.addSegment(new primitives.common.QuadraticArcSegment(f.horizontalCenter() + i * (l != k ? 1 : -1), (l ? f.top() : f.bottom()) + i, f.horizontalCenter() + i * (l != k ? 1 : -1), f.verticalCenter() + i)); a.addSegment(new primitives.common.QuadraticArcSegment(f.horizontalCenter() +
            i * (l != k ? 1 : -1), (l ? f.bottom() : f.top()) + i, e.x, e.y + i))
        }, !g), v.addArrow(this.lineWidth, function (a) { a.mergeTo(u.getPolyline(a.paletteItem)) }); p = new primitives.common.Rect(f.horizontalCenter() + (l != k ? m : -(m + n.width)), f.verticalCenter() - n.height / 2, n.width, n.height)
    } else if (a.verticalCenter() < b.top() || a.verticalCenter() > b.bottom()) {
        k = a.x < q.width / 2; d = new primitives.common.Point(k ? a.right() : a.left(), a.verticalCenter()); e = new primitives.common.Point(k ? b.right() : b.left(), b.verticalCenter()); s = r = k ? 3 : 7; f = new primitives.common.Rect(d,
        ...
        f.left(), f.verticalCenter(), e.x, e.y, 0.5); p = new primitives.common.Rect(j.x + (k ? m / 2 : -m / 2 - n.width), j.y - n.height / 2, n.width, n.height)
    } else {
        d = new primitives.common.Point(a.horizontalCenter(), a.top()); e = new primitives.common.Point(b.horizontalCenter(), b.top()); s = r = 1; f = new primitives.common.Rect(d, e); f.offset(0, 7 * m, 0, 0); k = d.x < e.x; g = 0; for (h = j.length; g < h; g += 1) i = j[g], u.addInverted(function (a) {
            a = a.getPolyline(t); a.addSegment(new primitives.common.MoveSegment(d.x + i, d.y)); a.addSegment(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),
            f.top() - i * (k ? -1 : 1), b.horizontalCenter() - i, b.top()))
        }, !g), v.addArrow(this.lineWidth, function (a) { a.mergeTo(u.getPolyline(a.paletteItem)) }); j = primitives.common.QuadraticArcSegment.prototype.offsetPoint(d.x, d.y, f.horizontalCenter(), f.top(), e.x, e.y, 0.5); p = new primitives.common.Rect(j.x - n.width / 2, j.y - (this.labelOffset + n.height), n.width, n.height)
    } u.transform(this.transform, !0); this.m_graphics.polylinesBuffer(u); if (this.hasLabel) {
        switch (this.labelPlacementType) {
            case primitives.common.ConnectorLabelPlacementType.From: p =
            this._getLabelPosition(a.x, a.y, a.width, a.height, p.width, p.height, this.labelOffset, r); break; case primitives.common.ConnectorLabelPlacementType.To: p = this._getLabelPosition(b.x, b.y, b.width, b.height, p.width, p.height, this.labelOffset, s)
        } this.transform.transformRect(p.x, p.y, p.width, p.height, !0, this, function (a, b, c, d) { p = new primitives.common.Rect(a, b, c, d) }); this.m_graphics.template(p.x, p.y, 0, 0, 0, 0, p.width, p.height, this.labelTemplate, this.labelTemplateHashCode, "onAnnotationLabelTemplateRender", c, null)
    }
};
...
primitives.common.Perimeter.prototype.draw = function (a) {
    var b = new primitives.common.PaletteItem({ lineColor: this.borderColor, lineWidth: this.lineWidth, fillColor: this.fillColor, lineType: this.lineType, opacity: this.opacity }), c = new primitives.common.Polyline(b), d = this.lineWidth / 2, e = null, f = null, g = null, h = {}; a.segments.iterate(function (b) {
        var i = 0, k = 0, l = !1; if (0 < d) switch (b.orientationType) {
            case 3: i = -d; l = !1; break; case 2: i = d; l = !1; break; case 0: k = d; l = !0; break; case 1: k = -d; l = !0; break; default: throw "Orientation is not defined!";
        ...
        g ? k.point.y = f.y : k.point.x = f.x) : h[b.oppositeKey] = { point: f, isVertical: g } : null != a.segments.item(e.oppositeKey) && !a.segments.item(b.oppositeKey) && (h.hasOwnProperty(e.key) ? (k = h[e.key], k.isVertical ? f.y = k.point.y : f.x = k.point.x, g ? k.point.y = f.y : k.point.x = f.x) : h[e.key] = { point: f, isVertical: l })), g = l, e = b); f = i
    }); 0 < d && !a.segments.item(e.oppositeKey) && (b = h[e.key], b.isVertical ? f.y = b.point.y : f.x = b.point.x, g ? b.point.y = f.y : b.point.x = f.x); c.transform(this.transform, !0); this.m_graphics.polyline(c)
};
...
primitives.common.PaletteManager = function (a) {
    this.palette = []; this.cursor = 0; var b, c; if (0 == a.linesPalette.length) this.palette = [new primitives.common.PaletteItem({ lineColor: a.linesColor, lineWidth: a.linesWidth, lineType: a.linesType })], this.paletteLength = this.palette.length, this.regularIndex = 0; else {
        b = 0; for (c = a.linesPalette.length; b < c; b += 1) this.palette.push(new primitives.common.PaletteItem(a.linesPalette[b])); this.paletteLength = this.palette.length; this.palette.push(new primitives.common.PaletteItem({
...
primitives.common.Polyline = function (a) {
    function b(a, b) { var c, d, e; if (null != b) { c = 0; for (d = h.length; c < d && (!(e = h[c]) || !b.call(a, e, c)) ; c += 1); } } function c() { return primitives.common.isNullOrEmpty(g.fillColor) } function d(a, b) { this.segment = a; this.pointIndex = b } function e(a, b, c, e, f) {
        var h = a.relateTo(b), g = f ? 0 : c; 2 == h ? b.offset(g) : 3 == h && 0 == b.from.context.pointIndex ? (h = new primitives.common.LineSegment(b.from), e.addSegment(h), b.offset(g), e = b.from.clone(), e.context = new d(h, 0), g = new primitives.common.Vector(a.to.clone(),
        e), f || (b.from = e.clone()), g.offset(c), g.intersect(a), g.from.context.pushToSegment(g.from), b.intersect(g), f && g.to.context.pushToSegment(g.to)) : (b.offset(g), b.intersect(a)); b.from.context.pushToSegment(b.from)
    } function f(a, b, c, d) { var f, h = a[0], g = h.to.context.segment.getEndPoint().toString(); b.hasOwnProperty(g) && (f = b[g], e(h, f, c, d, !0), delete b[g]); h.to.context.pushToSegment(h.to); a.length = 0 } var g = new primitives.common.PaletteItem, h = [], j, i; switch (arguments.length) { case 1: g = a } i = new primitives.common.PaletteItem({
        lineColor: g.lineColor,
        lineWidth: 0, fillColor: g.lineColor, opacity: 1
    }); d.prototype.pushToSegment = function (a) { this.segment.setPoint(a, this.pointIndex) }; return j = {
        paletteItem: g, arrowPaletteItem: i, addSegment: function (a) { h.push(a) }, addSegments: function (a) { h = h.concat(a) }, mergeTo: function (a) { a.addSegments(h) }, length: function () { return h.length }, loop: b, loopReversed: function (a, b) { var c, d; if (null != b) for (c = h.length - 1; 0 <= c && (!(d = h[c]) || !b.call(a, d, c)) ; c -= 1); }, transform: function (a, c) {
            b(this, function (b) {
                null != b.transform && b.transform(a,
                c)
            })
        }, isInvertable: c, addInverted: function (a) { var b = !1, d = []; c() ? a.loopReversed(this, function (a) { 4 != a.segmentType && (b || (h.push(new primitives.common.MoveSegment(a.getEndPoint())), b = !0), d.unshift(a), 1 < d.length && (d[1].invert(d[0].getEndPoint()), h.push(d[1]), d.length = 1)) }) : a.mergeTo(j) }, addArrow: function (a, b) {
            var c, d, e; e = h.length; var f = 3 * a, g = 2 * a; switch (a) { case 1: f = 8; g = 6; break; case 2: f = 12; g = 8; break; case 3: f = 16, g = 10 } if (null != b && 1 < e && (c = h[e - 2].getEndPoint(), e = h[e - 1], null != e.trim)) {
                d = new primitives.common.Point(e.getEndPoint());
                ...
                g.addSegment(new primitives.common.LineSegment(f[2].x, f[2].y)); g.addSegment(new primitives.common.QuadraticArcSegment(f[3].x, f[3].y, f[0].x, f[0].y)); b(g, c)
            }
        }, optimizeMoveSegments: function () {
            var a, b, c, d, e; c = {}; var f = [], g = []; a = 0; for (b = h.length; a < b - 1; a += 1) switch (d = h[a], e = h[a + 1], d.segmentType) { case 0: case 2: case 3: switch (e.segmentType) { case 1: case 4: d = d.x + "&" + d.y, c.hasOwnProperty(d) || (c[d] = a) } break; case 1: d = d.x + "&" + d.y, c.hasOwnProperty(d) && !f[c[d]] && (f[c[d]] = a + 1, g[a] = !0) } e = []; for (a = 0; a < b; a += 1) if (!g[a] &&
            (d = h[a], e.push(d), g[a] = !0, 0 < f[a])) for (c = f[a]; c < b && !g[c];) d = h[c], e.push(d), g[c] = !0, c = 0 < f[c] ? f[c] : c + 1; h = e
        }, getOffsetPolyine: function (a) {
            var c = new primitives.common.Polyline(g), h = {}, j = [], i = []; b(this, function (b) {
                var g = b.clone(); switch (g.segmentType) {
                    case 4: case 1: 0 < i.length && f(i, h, a, c); j.length = 0; 1 == g.segmentType && (b = new primitives.common.Point(g), b.context = new d(g, 0), j.push(b)); break; default: g.loop(this, function (b, f, r) {
                        b = new primitives.common.Point(b, f); b.context = new d(g, r); j.unshift(b); 1 < j.length &&
                        (i.unshift(new primitives.common.Vector(j[1].clone(), j[0].clone())), j.length = 1); switch (i.length) { case 1: r = i[0]; b = r.from.toString(); h[b] = r; r.offset(a); r.from.context.pushToSegment(r.from); break; case 2: b = i[1], r = i[0], e(b, r, a, c, !1), i.length = 1 }
                    })
                } c.addSegment(g)
            }); 0 < i.length && f(i, h, a, c); return c
        }, toString: function () { return g.toString() }
    }
};
primitives.common.PolylinesBuffer = function () {
    function a(a, b) { a[b.toString()] || (a[b.toString()] = new primitives.common.Polyline(b)); return a[b.toString()] } function b(a, b) { var f, g; if (null != b) for (f in c) if (c.hasOwnProperty(f) && (g = c[f])) if (g.optimizeMoveSegments(), b.call(a, g)) break } var c = {}; return {
        getPolyline: function (b) { return a(c, b) }, loop: b, addInverted: function (d, e) { var f, g; f = c; c = {}; null != d && d(this); b(this, function (b) { g = a(f, b.paletteItem); e ? b.mergeTo(g) : g.addInverted(b) }); c = f }, transform: function (a, c) {
            b(this,
...
primitives.common.Rect.prototype.addRect = function (a, b, c, d) {
    var e, f; switch (arguments.length) {
        case 1: a.isEmpty() || (this.isEmpty() ? (this.x = a.x, this.y = a.y, this.width = a.width, this.height = a.height) : (e = Math.max(this.right(), a.right()), f = Math.max(this.bottom(), a.bottom()), this.x = Math.min(this.x, a.x), this.y = Math.min(this.y, a.y), this.width = e - this.x, this.height = f - this.y)); break; case 2: this.isEmpty() ? (this.x = a, this.y = b, this.height = this.width = 0) : (e = Math.max(this.right(), a), f = Math.max(this.bottom(), b), this.x = Math.min(this.x,
        a), this.y = Math.min(this.y, b), this.width = e - this.x, this.height = f - this.y); break; case 4: this.isEmpty() ? (this.x = a, this.y = b, this.width = c, this.height = d) : (e = Math.max(this.right(), a + c), f = Math.max(this.bottom(), b + d), this.x = Math.min(this.x, a), this.y = Math.min(this.y, b), this.width = e - this.x, this.height = f - this.y)
    } return this
...
primitives.common.Graphics.prototype._activateLayer = function (a) {
    var b = this.m_activePlaceholder.layers[a], c, d, e, f; if (void 0 === b) {
        c = this.m_activePlaceholder; if (-1 === a) b = new primitives.common.Layer(a), b.canvas = c.div; else {
            d = jQuery("<div></div>"); d.addClass("Layer" + a); new primitives.common.Rect(c.rect); d.css({ position: "absolute", width: "0px", height: "0px" }); e = null; for (f in c.layers) c.layers.hasOwnProperty(f) && (b = c.layers[f], b.name < a && (e = null !== e ? Math.max(e, b.name) : b.name)); b = new primitives.common.Layer(a);
            b.canvas = d; null === e ? c.div.prepend(b.canvas[0]) : b.canvas.insertAfter(c.layers[e].canvas)
        } c.layers[a] = b
    } this.m_activePlaceholder.activeLayer = b
};
primitives.common.Graphics.prototype.text = function (a, b, c, d, e, f, g, h, j) {
    var i = this.m_activePlaceholder, g = { position: "absolute", padding: 0, margin: 0, "text-align": this._getTextAlign(g), "font-size": j["font-size"], "font-family": j["font-family"], "font-weight": j["font-weight"], "font-style": j["font-style"], color: j["font-color"], "line-height": j["font-size"] }, j = ""; switch (f) {
        case 0: case 3: g.left = a; g.top = b; g.width = c; g.height = d; break; case 1: g.left = a + Math.round(c / 2 - d / 2); g.top = b + Math.round(d / 2 - c / 2); g.width = d; g.height =
        c; j = "rotate(-90deg)"; break; case 2: g.left = a + Math.round(c / 2 - d / 2), g.top = b + Math.round(d / 2 - c / 2), g.width = d, g.height = c, j = "rotate(90deg)"
    } g["-webkit-transform-origin"] = "center center"; g["-moz-transform-origin"] = "center center"; g["-o-transform-origin"] = "center center"; g["-ms-transform-origin"] = "center center"; g["-webkit-transform"] = j; g["-moz-transform"] = j; g["-o-transform"] = j; g["-ms-transform"] = j; g.transform = j; g["max-width"] = g.width; g["max-height"] = g.height; e = e.replace(RegExp("\n", "g"), "<br/>"); switch (h) {
        case 0: this.debug &&
...
primitives.common.Graphics.prototype.dot = function (a, b, c, d, e, f) {
    var g = this.m_activePlaceholder, h = this.m_cache.get(g.name, g.activeLayer.name, "dot"), j = void 0 !== f.lineWidth && void 0 !== f.borderColor, a = {
        position: "absolute", width: c - (j ? 1 : 0), top: Math.round(b), left: Math.round(a), padding: 0, margin: 0, "line-height": "0px", overflow: "hidden", height: d - (j ? 1 : 0), background: f.fillColor, "-moz-border-radius": e, "-webkit-border-radius": e, "-khtml-border-radius": e, "border-radius": e, "font-size": "0px", "border-style": j ? "Solid" :
        "None", "border-width": j ? "1px" : "0px", "border-color": j ? f.borderColor : ""
...
primitives.common.Graphics.prototype.template = function (a, b, c, d, e, f, g, h, j, i, k, l, m) {
    var c = this.m_activePlaceholder, d = "template" + (null !== i ? i : primitives.common.hashCode(j)), n = 0, i = this.m_cache.get(c.name, c.activeLayer.name, d); null !== m && void 0 !== m["border-width"] && (n = this.boxModel ? this.getPxSize(m["border-width"]) : 0); a = { width: g - n + "px", height: h - n + "px", top: b + f + "px", left: a + e + "px" }; jQuery.extend(a, m); null == l && (l = new primitives.common.RenderEventArgs); null == i ? (i = jQuery(j), jQuery.extend(a, {
        position: "absolute",
        padding: "0px", margin: "0px"
    }, m), primitives.common.css(i, a), l.element = i, l.renderingMode = 0, null !== k && this.m_widget._trigger(k, null, l), c.activeLayer.canvas.append(i), this.m_cache.put(c.name, c.activeLayer.name, d, i)) : (l.element = i, l.renderingMode = 1, primitives.common.css(i, a), null !== k && this.m_widget._trigger(k, null, l)); return i
};
...
primitives.common.CanvasGraphics.prototype.polyline = function (a) {
    var b = this.m_activePlaceholder, c, d, e = a.paletteItem.toAttr(), f, g; if (b.hasGraphics) {
        c = b.activeLayer; d = this._getContext(b, c); d.save(); void 0 !== e.lineWidth && void 0 !== e.borderColor ? (d.strokeStyle = e.borderColor, d.lineWidth = e.lineWidth) : (d.lineWidth = 0, d.strokeStyle = "Transparent"); if (null != e.lineType) {
            b = Math.round(e.lineWidth) || 1; switch (e.lineType) { case 0: f = []; break; case 1: f = [b, b]; break; case 2: f = [5 * b, 3 * b] } void 0 !== d.setLineDash ? d.setLineDash(f) :
        ...
        }); void 0 !== e.lineWidth && d.stroke(); void 0 !== e.fillColor && (d.fillStyle = e.fillColor, d.globalAlpha = e.opacity, d.fill()); d.restore()
...
primitives.common.SvgGraphics.prototype.polyline = function (a) {
    ...
    0)); if (null != e.lineType) switch (f = Math.round(e.lineWidth) || 1, e.lineType) { case 0: c.setAttribute("stroke-dasharray", ""); break; case 1: c.setAttribute("stroke-dasharray", f + "," + f); break; case 2: c.setAttribute("stroke-dasharray", 5 * f + "," + 3 * f) } d = ""; a.loop(this, function (a) {
        switch (a.segmentType) {
            case 1: d += "M" + (Math.round(a.x) + 0.5) + " " + (Math.round(a.y) + 0.5); break; case 0: d += "L" + (Math.round(a.x) + 0.5) + " " + (Math.round(a.y) + 0.5); break; case 2: d += "Q" + (Math.round(a.cpX) + 0.5) + " " + (Math.round(a.cpY) + 0.5) + " " + (Math.round(a.x) +
...
primitives.common.VmlGraphics = function (a) {
    var b, c, d; this.parent = primitives.common.Graphics.prototype; this.parent.constructor.apply(this, arguments); this.prefix = "rvml"; this.ie8mode = document.documentMode && 8 <= document.documentMode; try { eval("document.namespaces") } catch (e) { } document.namespaces[this.prefix] || document.namespaces.add(this.prefix, "urn:schemas-microsoft-com:vml"); if (!primitives.common.VmlGraphics.prototype.vmlStyle) {
...
primitives.common.VmlGraphics.prototype.polyline = function (a) {
    ...
    "," + d.height); e.style.top = c.y + "px"; e.style.left = c.x + "px"; e.style.width = c.width + "px"; e.style.height = c.height + "px"; f = ""; a.loop(this, function (a) {
        switch (a.segmentType) {
            case 1: f += " m" + 10 * Math.round(a.x) + "," + 10 * Math.round(a.y); break; case 0: f += " l" + 10 * Math.round(a.x) + "," + 10 * Math.round(a.y); break; case 4: h = Math.round(a.x); j = Math.round(a.y); i = Math.round(a.x + a.width); k = Math.round(a.y + a.height); h > i && (l = h, h = i, i = l); j > k && (l = j, j = k, k = l); h = 10 * h + 5; j = 10 * j + 5; i = 10 * i - 5; k = 10 * k - 5; f += " m" + h + "," + j; f += " l" + i + "," + j; f += " l" + i +
            "," + k; f += " l" + h + "," + k; f += " l" + h + "," + j; break; case 2: f += " qb" + 10 * Math.round(a.cpX) + "," + 10 * Math.round(a.cpY) + " l" + 10 * Math.round(a.x) + "," + 10 * Math.round(a.y); break; case 3: f += " c" + 10 * Math.round(a.cpX1) + "," + 10 * Math.round(a.cpY1) + "," + 10 * Math.round(a.cpX2) + "," + 10 * Math.round(a.cpY2) + "," + 10 * Math.round(a.x) + "," + 10 * Math.round(a.y)
        }
    }); f += " e"; a = "shapepath"; c = new primitives.common.Element(this.prefix + ":path"); c.setAttribute("v", f); e.appendChild(c); if (null != g.lineType) {
        c = new primitives.common.Element(this.prefix +
        ":stroke"); switch (g.lineType) { case 0: c.setAttribute("dashstyle", "Solid"); break; case 1: c.setAttribute("dashstyle", "ShortDot"); break; case 2: c.setAttribute("dashstyle", "Dash") } e.appendChild(c); a += "stroke"
    } null !== g.fillColor ? (e.setAttribute("filled", !0), c = new primitives.common.Element(this.prefix + ":fill"), c.setAttribute("opacity", g.opacity), c.setAttribute("color", g.fillColor), e.appendChild(c), a += "fill") : e.setAttribute("filled", !1); g = this.m_cache.get(b.name, b.activeLayer.name, a); null === g ? (g = jQuery(e.create(this.ie8mode)),
    b.activeLayer.canvas.append(g), this.m_cache.put(b.name, b.activeLayer.name, a, g)) : e.update(g[0], this.ie8mode)
}; primitives.text.Config = function () { this.classPrefix = "bptext"; this.graphicsType = 0; this.actualGraphicsType = null; this.orientation = 0; this.text = ""; this.verticalAlignment = 1; this.horizontalAlignment = 0; this.fontSize = "16px"; this.fontFamily = "Arial"; this.color = "#000000"; this.fontStyle = this.fontWeight = "normal" };
...
primitives.text.Controller.prototype._createLayout = function () {
    ...
    this.m_graphics = primitives.common.createGraphics(this.options.graphicsType, this); this.options.actualGraphicsType = this.m_graphics.graphicsType
...
primitives.orgdiagram.BaseController.prototype._createLayout = function () {
    this.m_scrollPanelRect = new primitives.common.Rect(0, 0, this.element.outerWidth(), this.element.outerHeight()); this.m_placeholderRect = new primitives.common.Rect(this.m_scrollPanelRect); var a = this.element.offset(); this.m_scrollPanel = jQuery('<div tabindex="0"></div>'); this.m_scrollPanel.css({
        position: "relative", overflow: "auto", top: "0px", left: "0px", width: this.m_scrollPanelRect.width + "px", height: this.m_scrollPanelRect.height + "px", padding: "0px",
        "margin-bottom": "0px", "margin-right": "0px", "margin-top": -a.top + Math.floor(a.top) + "px", "margin-left": -a.left + Math.floor(a.left) + "px", "-webkit-overflow-scrolling": "touch"
    }); this.m_scrollPanel.addClass(this.widgetEventPrefix); this.m_placeholder = jQuery("<div></div>"); this.m_placeholder.css({ position: "absolute", overflow: "hidden", top: "0px", left: "0px" }); this.m_placeholder.addClass("placeholder"); this.m_placeholder.addClass(this.widgetEventPrefix); this.m_placeholder.css(this.m_placeholderRect.getCSS()); this.m_scrollPanel.append(this.m_placeholder);
...
primitives.orgdiagram.BaseController.prototype._virtualUnbind = function () {
    ...
    null; this.options.onGroupTitleTemplateRender = null; this.options.onButtonsTemplateRender = null; this.options.onAnnotationLabelTemplateRender = null
}; primitives.orgdiagram.BaseController.prototype.update = function (a) { switch (a) { case 2: this._redrawHighlight(); break; case 1: this._refresh(); break; default: this._redraw() } };
...
primitives.orgdiagram.BaseController.prototype._onKeyDown = function (a) {
    var b, c, d, e = null != this._highlightTreeItem ? this._highlightTreeItem : this._cursorTreeItem, f, g, h = null, j; if (null != e) {
        switch (a.which) { case 13: this._setCursorItem(a, e); a.preventDefault(); this.m_scrollPanel.focus(); break; case 40: h = 1; break; case 38: h = 0; break; case 37: h = 2; break; case 39: h = 3 } if (null != h) {
            for (j = !1; !j;) {
                j = !0; h = this.transform.getOrientation(h); switch (h) {
                    case 0: g = this._getNextLevelTreeItem(e, !1); break; case 1: g = this._getNextLevelTreeItem(e,
                    !0); break; case 2: b = this._treeLevels[e.level]; for (c = e.levelPosition - 1; 0 <= c; c -= 1) if (f = this._visualTree.node(b.treeItems[c]), 1 == f.actualVisibility) { g = f; break } break; case 3: b = this._treeLevels[e.level]; c = e.levelPosition + 1; for (d = b.treeItems.length; c < d; c += 1) if (f = this._visualTree.node(b.treeItems[c]), 1 == f.actualVisibility) { g = f; break }
...
primitives.orgdiagram.BaseController.prototype._redrawTreeItems = function () {
    var a, b, c = new primitives.common.PolylinesBuffer, d = {}, e, f, g, h, j = new primitives.common.Marker, i, k; this.transform.setOrientation(this.options.orientationType); f = 0; for (g = this._treeLevels.length; f < g; f += 1) a = this._treeLevels[f], a.labels = [], a.labelsRect = null, a.hasFixedLabels = !1, a.showLabels = !0; this._visualTree.loop(this, function (a, f) {
        var g = f.orgItem, p = this._treeLevels[f.level]; f.setActualPosition(p, this.options); this.transform.transformRect(f.actualPosition.x,
        f.actualPosition.y, f.actualPosition.width, f.actualPosition.height, !0, this, function (a, l, q, t) {
            switch (f.actualVisibility) {
                case 1: b = new primitives.common.RenderEventArgs; b.context = f.itemConfig; b.isCursor = f.isCursor; b.isSelected = f.isSelected; b.templateName = f.template.name; this.graphics.activate("placeholder", 7); this.graphics.template(a, l, q, t, f.contentPosition.x, f.contentPosition.y, f.contentPosition.width, f.contentPosition.height, f.template.itemTemplate, f.template.itemTemplateHashCode, f.template.itemTemplateRenderName,
                ...
                h.text = g.title, h.position = new primitives.common.Rect(a, l, q, t), h.weight = 1E4, h.labelType = 1, p.labels.push(h)); break; case 2: i = f.template.minimizedItemBorderColor || g.itemTitleColor || "#000080"; k = f.template.minimizedItemFillColor || g.itemTitleColor || "#000080"; var u = null !== g.minimizedItemShapeType ? g.minimizedItemShapeType : null !== f.template.minimizedItemShapeType ? f.template.minimizedItemShapeType : this.options.minimizedItemShapeType; null == u || 6 == u ? (e = c.getPolyline(new primitives.common.PaletteItem({
                    lineColor: i,
                    lineWidth: f.template.minimizedItemLineWidth, lineType: f.template.minimizedItemLineType, fillColor: k, opacity: f.template.minimizedItemOpacity
                })), e.addSegment(new primitives.common.DotSegment(a, l, q, t, f.template.minimizedItemCornerRadius))) : j.draw(c, u, new primitives.common.Rect(a, l, q, t), new primitives.common.PaletteItem({ lineColor: i, lineWidth: f.template.minimizedItemLineWidth, lineType: f.template.minimizedItemLineType, fillColor: k, opacity: f.template.minimizedItemOpacity })); h = this._createLabel(a, l, q, t, f);
                    null != h && p.labels.push(h); break; default: this._debug && (i = "#ff0000", d.hasOwnProperty(i) || (d[i] = new primitives.common.PaletteItem({ lineColor: i, lineWidth: 1, lineType: 0, fillColor: i, opacity: 1 })), e = c.getPolyline(d[i]), e.addSegment(new primitives.common.DotSegment(a - 1, l - 1, 2, 2, 1)))
            }
        })
    }); this.graphics.activate("placeholder", 4); this.graphics.polylinesBuffer(c); this._redrawLabels()
};
primitives.orgdiagram.BaseController.prototype._redrawLabels = function () {
    var a, b, c, d, e, f, g, h; if (0 == this.options.showLabels) {
        g = 0; for (h = this._treeLevels.length; g < h; g += 1) { e = this._treeLevels[g]; a = e.labels; d = 0; for (f = a.length; d < f; d += 1) b = a[d], null == e.labelsRect ? e.labelsRect = new primitives.common.Rect(b.position) : e.labelsRect.addRect(b.position), e.hasFixedLabels = e.hasFixedLabels || 2 == b.labelType } for (g = this._treeLevels.length - 1; 0 < g; g -= 1) a = this._treeLevels[g - 1], b = this._treeLevels[g], null != a.labelsRect && null !=
        b.labelsRect && a.labelsRect.overlaps(b.labelsRect) && (b.showLabels = !1); g = 0; for (h = this._treeLevels.length; g < h; g += 1) if (e = this._treeLevels[g], a = e.labels, e.showLabels) { d = 0; for (f = a.length; d < f; d += 1) if (b = a[d], b.isActive) for (e = d + 1; e < f; e += 1) if (c = a[e], c.isActive) if (b.position.overlaps(c.position)) if (b.weight >= c.weight) 0 == c.labelType && (c.isActive = !1); else { 0 == b.labelType && (b.isActive = !1); break } else break }
    } this.graphics.activate("placeholder", 5); c = {
        "font-size": this.options.labelFontSize, "font-family": this.options.labelFontFamily,
        "font-style": this.options.labelFontStyle, "font-weight": this.options.labelFontWeight, "font-color": this.options.labelColor
    }; g = 0; for (h = this._treeLevels.length; g < h; g += 1) if (e = this._treeLevels[g], e.showLabels || e.hasFixedLabels) { a = e.labels; d = 0; for (f = a.length; d < f; d += 1) if (b = a[d], b.isActive) switch (b.labelType) { case 0: case 2: this.graphics.text(b.position.x, b.position.y, b.position.width, b.position.height, b.text, b.labelOrientation, b.horizontalAlignmentType, b.verticalAlignmentType, c) } }
};
primitives.orgdiagram.BaseController.prototype._createLabel = function (a, b, c, d, e) {
    var f, g, h = null, j = this.options.labelOffset, i; i = e.orgItem; if (!primitives.common.isNullOrEmpty(i.label)) {
        switch (i.showLabel) {
            ...
            h.text = i.label; e = null != i.labelSize ? i.labelSize : this.options.labelSize; h.labelOrientation = 3 != i.labelOrientation ? i.labelOrientation : 3 != this.options.labelOrientation ? this.options.labelOrientation : 0; i = 0 != i.labelPlacement ? i.labelPlacement : 0 != this.options.labelPlacement ? this.options.labelPlacement : 1; switch (h.labelOrientation) { case 0: f = e.width; g = e.height; break; case 1: case 2: g = e.width, f = e.height } switch (i) {
                case 0: case 1: h.position = new primitives.common.Rect(a + c / 2 - f / 2, b - j - g, f, g); switch (h.labelOrientation) {
                    case 0: h.horizontalAlignmentType =
                    0; h.verticalAlignmentType = 2; break; case 1: h.horizontalAlignmentType = 1; h.verticalAlignmentType = 1; break; case 2: h.horizontalAlignmentType = 2, h.verticalAlignmentType = 1
                } break; case 2: case 11: h.position = new primitives.common.Rect(a + c + j, b - j - g, f, g); switch (h.labelOrientation) { case 0: h.horizontalAlignmentType = 1; h.verticalAlignmentType = 2; break; case 1: h.horizontalAlignmentType = 1; h.verticalAlignmentType = 0; break; case 2: h.horizontalAlignmentType = 2, h.verticalAlignmentType = 2 } break; case 3: h.position = new primitives.common.Rect(a +
                c + j, b + d / 2 - g / 2, f, g); switch (h.labelOrientation) { case 0: h.horizontalAlignmentType = 1; h.verticalAlignmentType = 1; break; case 1: h.horizontalAlignmentType = 0; h.verticalAlignmentType = 0; break; case 2: h.horizontalAlignmentType = 0, h.verticalAlignmentType = 2 } break; case 4: case 12: h.position = new primitives.common.Rect(a + c + j, b + d + j, f, g); switch (h.labelOrientation) {
                    case 0: h.horizontalAlignmentType = 1; h.verticalAlignmentType = 0; break; case 1: h.horizontalAlignmentType = 2; h.verticalAlignmentType = 0; break; case 2: h.horizontalAlignmentType =
                    1, h.verticalAlignmentType = 2
                } break; case 5: h.position = new primitives.common.Rect(a + c / 2 - f / 2, b + d + j, f, g); switch (h.labelOrientation) { case 0: h.horizontalAlignmentType = 0; h.verticalAlignmentType = 0; break; case 1: h.horizontalAlignmentType = 2; h.verticalAlignmentType = 1; break; case 2: h.horizontalAlignmentType = 1, h.verticalAlignmentType = 1 } break; case 6: case 10: h.position = new primitives.common.Rect(a - f - j, b + d + j, f, g); switch (h.labelOrientation) {
                    case 0: h.horizontalAlignmentType = 2; h.verticalAlignmentType = 0; break; case 1: h.horizontalAlignmentType =
                    2; h.verticalAlignmentType = 2; break; case 2: h.horizontalAlignmentType = 1, h.verticalAlignmentType = 0
                } break; case 7: h.position = new primitives.common.Rect(a - f - j, b + d / 2 - g / 2, f, g); switch (h.labelOrientation) { case 0: h.horizontalAlignmentType = 2; h.verticalAlignmentType = 1; break; case 1: h.horizontalAlignmentType = 0; h.verticalAlignmentType = 2; break; case 2: h.horizontalAlignmentType = 0, h.verticalAlignmentType = 0 } break; case 8: case 9: switch (h.position = new primitives.common.Rect(a - f - j, b - j - g, f, g), h.labelOrientation) {
                    case 0: h.horizontalAlignmentType =
                    2; h.verticalAlignmentType = 2; break; case 1: h.horizontalAlignmentType = 1; h.verticalAlignmentType = 2; break; case 2: h.horizontalAlignmentType = 2, h.verticalAlignmentType = 0
                }
            }
        }
    } return h
...
primitives.orgdiagram.BaseController.prototype._tracePathAnnotations = function () {
    var a, b, c, d, e, f, g, h, j, i, k, l; a = 0; for (b = this.options.annotations.length; a < b; a += 1) switch (c = this.options.annotations[a], c.annotationType) {
        case 2: if (null == j && (j = this._getConnectionsGraph()), null != c.items && 0 < c.items.length && (k = c.items.slice(0), e = this._treeItemsByUserId[k[0]], null != e && (1 == k.length && this._navigationFamily.loopParents(this, e.id, function (a, b) { null != b.itemConfig && k.push(b.itemConfig.id); return this._navigationFamily.SKIP }),
...
primitives.orgdiagram.BaseController.prototype._getConnectionsGraph = function () {
    var a, b, c, d, e, f, g, h, j, i, k, l, m = primitives.common.graph(); b = 0; for (c = this._treeLevels.length; b < c; b += 1) {
        a = this._treeLevels[b]; d = 0; for (e = a.treeItems.length; d < e; d += 1) {
            h = a.treeItems[d]; h = this._visualTree.node(h); i = h.actualIsActive ? 100 : 1; h.connectorPlacement & 8 ? k = [a.treeItems[h.levelPosition - 1]] : h.connectorPlacement & 2 ? k = [a.treeItems[h.levelPosition + 1]] : h.connectorPlacement & 1 ? (f = this._visualTree.parent(h.id), k = 1 < f.partners.length ?
            f.partners.slice(0) : [f.id], 0 < f.extraPartners.length && (k = k.concat(f.extraPartners))) : k = []; f = 0; for (g = k.length; f < g; f += 1) l = k[f], j = this._visualTree.node(l), j = j.actualIsActive ? 100 : 1, j = new primitives.famdiagram.EdgeItem(h.id, i, l, j), j.highlightItemId = h.id, 1 != g && (j.partnerid = l), m.addEdge(h.id, l, j)
        }
    } return m
};
...
primitives.orgdiagram.BaseController.prototype._drawAnnotations = function () {
    var a; a = 8; var b, c, d, e, f, g, h, j, i, k, l, m, n, p; b = 0; for (c = this.options.annotations.length; b < c; b += 1) switch (m = this.options.annotations[b], m.annotationType) {
        case 0: if (null != m.fromItem && null != m.toItem && (e = this._treeItemsByUserId[m.fromItem], f = this._treeItemsByUserId[m.toItem], null != e && null != f)) {
            h = new primitives.orgdiagram.ConnectorAnnotationConfig; g = new primitives.common.Connector(this.graphics); g.orientationType = this.options.orientationType;
...
primitives.orgdiagram.BaseController.prototype._redrawConnector = function (a, b, c, d, e) {
    var f = this, g, h, j, i, k, l, m, n, p, r, s, q, t, u = 0, v, x = 0 == this.options.connectorType, w, z; t = 0 < d.partnerConnectorOffset ? e.shift + e.connectorShift - e.levelSpace / 2 * (e.partnerConnectorOffset - d.partnerConnectorOffset + 1) : d.connectorPlacement & 4 ? d.actualPosition.bottom() : e.shift + e.connectorShift; 1 >= d.partnerConnectorOffset ? c.selectPalette(0) : 1 < d.partnerConnectorOffset ? c.selectPalette(d.partnerConnectorOffset - 1) : c.selectPalette(e.partnerConnectorOffset);
    this._visualTree.hasChildren(d.id) && (g = 4 === d.actualVisibility && null == this._visualTree.parentid(d.id), q = d.actualPosition.horizontalCenter()); j = []; if (1 < d.partners.length || 0 < d.extraPartners.length) {
        i = d.partners; for (m = 0; m < i.length; m += 1) k = this._visualTree.node(i[m]), v = new primitives.orgdiagram.ConnectorPoint(k.actualPosition.horizontalCenter(), k.actualPosition.bottom()), v.isSquared = !0, v.highlightPath = k.partnerHighlightPath, v.connectorStyleType = k.partnerHighlightPath ? 2 : 1, v.visibility = k.actualVisibility,
        j.push(v); i = d.extraPartners; for (m = 0; m < i.length; m += 1) k = this._visualTree.node(i[m]), v = new primitives.orgdiagram.ConnectorPoint(k.actualPosition.horizontalCenter(), k.actualPosition.bottom()), v.isSquared = !0, v.highlightPath = k.partnerHighlightPath, v.connectorStyleType = k.partnerHighlightPath ? 2 : 0, v.visibility = k.actualVisibility, j.push(v); 0 < j.length && (j.sort(function (a, b) { return a.x - b.x }), this._visualTree.hasChildren(d.id) || (q = (j[0].x + j[j.length - 1].x) / 2), b.addInverted(function (b) {
            f._drawTopConnectors(b, c,
            q, t, j, !0, a, 1 == f.options.arrowsDirection)
        }))
    } h = []; this._visualTree.hasChildren(d.id) && (s = !1, this._visualTree.loopChildren(this, d.id, function (d, e) {
        l = this._treeLevels[e.level]; w = c.getPalette(e.highlightPath ? 2 : 1); z = b.getPolyline(w); if (e.connectorPlacement & 8) n = this._visualTree.node(l.treeItems[e.levelPosition - 1]), this.transform.transformPoints(e.actualPosition.x, l.shift + l.horizontalConnectorsDepth, n.actualPosition.right(), l.shift + l.horizontalConnectorsDepth, !0, this, function (a, c, d, g) {
            f._drawLineWithArrow(a,
            c, d, g, b, z, e.actualVisibility, n.actualVisibility)
        }); else if (e.connectorPlacement & 2) p = this._visualTree.node(l.treeItems[e.levelPosition + 1]), this.transform.transformPoints(e.actualPosition.right(), l.shift + l.horizontalConnectorsDepth, p.actualPosition.x, l.shift + l.horizontalConnectorsDepth, !0, this, function (a, c, d, g) { f._drawLineWithArrow(a, c, d, g, b, z, e.actualVisibility, p.actualVisibility) }); else if (e.connectorPlacement & 1 && !g) {
            r = !0; if (a) switch (e.actualVisibility) { case 2: case 3: r = x } v = new primitives.orgdiagram.ConnectorPoint(e.actualPosition.horizontalCenter() +
            0, e.actualPosition.top()); v.isSquared = r; v.connectorStyleType = e.highlightPath ? 2 : 1; v.visibility = e.actualVisibility; h.push(v); u = Math.max(u, v.connectorStyleType); s = s || v.isSquared
        }
    }), !g && 0 < h.length && (this.transform.transformPoints(q, t, q, e.shift + e.connectorShift, !0, this, function (a, e, g, i) {
        var k = Math.round(f.options.elbowDotSize / 2), l = c.getPalette(u), m = b.getPolyline(l), m = b.getPolyline(m.arrowPaletteItem); this.showElbowDots && (0 != this.options.elbowType && 0 < d.partners.length) && m.addSegment(new primitives.common.DotSegment(a -
    ...
    }), this._drawTopConnectors(b, c, q, e.shift + e.connectorShift,
    h, s, a, 2 == this.options.arrowsDirection)))
...
primitives.orgdiagram.BaseController.prototype._drawTopConnectors = function (a, b, c, d, e, f, g, h) {
    var j, i, k, l = [], m, n, p, r = this; if (f) {
        l = []; f = 0; for (i = e.length; f < i; f += 1) if (k = e[f], k.x < c && !k.isSquared) l.push(k); else break; i = l.length; 0 < i && this._drawAngularConnectors(a, b, c, d, l, !1, h); l = []; for (j = e.length - 1; j >= f; j -= 1) if (k = e[j], k.x > c && !k.isSquared) l.push(k); else break; i = l.length; 0 < i && this._drawAngularConnectors(a, b, c, d, l, !1, h); l = {}; i = {}; for (n in primitives.common.ConnectorStyleType) primitives.common.ConnectorStyleType.hasOwnProperty(n) &&
        (l[primitives.common.ConnectorStyleType[n]] = c, i[primitives.common.ConnectorStyleType[n]] = c); for (n = f; n <= j; n += 1) {
            k = e[n]; m = b.getPalette(k.connectorStyleType); p = a.getPolyline(m); m = this.options.dotItemsInterval / 2; 2 > m && (m = 0); if (g) switch (this.options.elbowType) {
                case 2: case 3: 0 < m && (Math.abs(c - k.x) > m && Math.abs(d - k.y) > m) && (k.hasElbow = !0, k.elbowPoint1 = new primitives.common.Point(k.x, d + (d > k.y ? -m : m)), k.elbowPoint2 = new primitives.common.Point(k.x + (c > k.x ? m : -m), d)); break; case 1: 0 < j - f && this.transform.transformPoints(k.x,
                d, k.x, k.y, !0, this, function (b, c) { var d = Math.round(r.options.elbowDotSize / 2); a.getPolyline(p.arrowPaletteItem).addSegment(new primitives.common.DotSegment(b - d, c - d, 2 * d, 2 * d, d)) })
            } l[k.connectorStyleType] = Math.min(l[k.connectorStyleType], k.hasElbow ? k.elbowPoint2.x : k.x); i[k.connectorStyleType] = Math.max(i[k.connectorStyleType], k.hasElbow ? k.elbowPoint2.x : k.x)
        } m = [Math.max(0, f - 1), Math.min(j + 1, e.length - 1)]; for (n = 0; n < m.length; n += 1) k = e[m[n]], l[k.connectorStyleType] = Math.min(l[k.connectorStyleType], k.hasElbow ? k.elbowPoint2.x :
        k.x), i[k.connectorStyleType] = Math.max(i[k.connectorStyleType], k.hasElbow ? k.elbowPoint2.x : k.x); k = c; for (n = 2; 0 <= n; n -= 1) m = b.getPalette(n), p = a.getPolyline(m), m = l[n], null != m && m < k && (this.transform.transformPoints(k, d, m, d, !0, this, function (a, b, c, d) { p.addSegment(new primitives.common.MoveSegment(a, b)); p.addSegment(new primitives.common.LineSegment(c, d)) }), k = m), m = i[n], null != m && m > c && (this.transform.transformPoints(c, d, m, d, !0, this, function (a, b, c, d) {
            ...
            d))
        }), c = m); for (n = f; n <= j; n += 1) k = e[n], m = b.getPalette(k.connectorStyleType), p = a.getPolyline(m), k.hasElbow ? (this.transform.transform3Points(k.elbowPoint2.x, k.elbowPoint2.y, k.elbowPoint1.x, k.elbowPoint2.y, k.elbowPoint1.x, k.elbowPoint1.y, !0, this, function (a, b, c, d, e, f) {
            switch (this.options.elbowType) {
                case 2: p.addSegment(new primitives.common.MoveSegment(a, b)); p.addSegment(new primitives.common.LineSegment(e, f)); break; case 3: p.addSegment(new primitives.common.MoveSegment(a, b)), p.addSegment(new primitives.common.CubicArcSegment(a,
                b, c, d, e, f))
            }
    ...
    } else this._drawAngularConnectors(a, b, c, d,
    e, !0, h)
};
primitives.orgdiagram.BaseController.prototype._drawAngularConnectors = function (a, b, c, d, e, f, g) {
    var h = null, j = e.length, i, k, l, m, h = f ? c : e[j - 1].x; k = new primitives.common.Point(h, d); for (c = 0; c < j; c += 1) {
        l = e[c]; i = b.getPalette(l.connectorStyleType); m = a.getPolyline(i); this.transform.transformPoint(h, d, !0, this, function (a, b) { m.addSegment(new primitives.common.MoveSegment(a, b)) }); switch (this.options.connectorType) {
            case 1: this.transform.transformPoint(l.x, l.y, !0, this, function (a, b) { m.addSegment(new primitives.common.LineSegment(a, b)) });
                ...
                i.bottom(), !0, this, function (a, b, c, d) { m.addSegment(new primitives.common.QuadraticArcSegment(a, b, c, d)) }) : this.transform.transformPoints(i.right(), i.y, i.right(), i.bottom(), !0, this, function (a, b, c, d) { m.addSegment(new primitives.common.QuadraticArcSegment(a, b, c, d)) })
        } g && 4 != l.visibility && m.addArrow(this.options.linesWidth, function (b, c) { var d; b.mergeTo(a.getPolyline(b.paletteItem)); this._debug && (d = a.getPolyline({ fillColor: "#ff0000" }), d.addSegment(new primitives.common.DotSegment(c.x - 1, c.y - 1, 2, 2, 1))) })
    }
};
...
primitives.orgdiagram.BaseController.prototype._getTreeItemForMousePosition = function (a, b) {
    var c = null, d = this, e, f, g; this.graphics.activate("placeholder", 7); a /= this.scale; b /= this.scale; this.transform.transformPoint(a, b, !1, this, function (a, b) {
        e = 0; for (f = this._treeLevels.length; e < f; e += 1) if (g = d._treeLevels[e], 0 < g.activeTreeItems.length && b > g.shift + g.topConnectorShift && b <= g.shift + g.connectorShift) {
            c = d._visualTree.node(primitives.common.binarySearch(g.activeTreeItems, function (c) {
                c = d._visualTree.node(c); switch (c.actualVisibility) {
                    case 1: if (c.actualPosition.contains(a,
                    b)) return 0; case 2: case 3: return a - c.actualPosition.horizontalCenter(); case 4: if (d._debug) throw "Clickable items collection should contain only visible items.";
                }
            })); break
        }
    }); return c
...
primitives.orgdiagram.BaseController.prototype._drawHighlightAnnotation = function () {
    var a = primitives.common, b, c, d, e, f; e = !0; var g; if (null !== this._highlightTreeItem) switch (this._highlightTreeItem.actualVisibility) {
        case 2: case 3: case 1: b = this._highlightTreeItem; c = b.orgItem; switch (c.showCallout) { case 2: e = !1; break; case 1: e = !1; break; default: e = this.options.showCallout } e ? (this.graphics.activate("placeholder", 7), e = this._getTransformedItemPosition(b), e = new a.Point(e.horizontalCenter(), e.verticalCenter()), d =
...
primitives.orgdiagram.BaseController.prototype._positionTreeItems = function () {
    var a = new primitives.common.Rect(0, 0, (this.m_scrollPanelRect.width - 25) / this.scale, (this.m_scrollPanelRect.height - 25) / this.scale), b = new primitives.common.Rect(0, 0, 0, 0), c, d, e, f, g; switch (this.options.orientationType) { case 2: case 3: a.invert() } if (0 < this._treeLevels.length) {
        switch (this.options.pageFitMode) {
            case 0: case 4: case 5: c = [new primitives.orgdiagram.LevelVisibility(0, 1)]; b = this._setTreeLevelsVisibilityAndPositionTreeItems(c,
            ...
            c.length - 1), this._checkDiagramSize(b, d))) { for (g = f = c.length - 1; 1 < f - e;) g = Math.floor((f + e) / 2), b = this._setTreeLevelsVisibilityAndPositionTreeItems(c, g), this._checkDiagramSize(b, d) ? f = g : e = g; f !== g && (b = this._setTreeLevelsVisibilityAndPositionTreeItems(c, f)) }
        } switch (this.options.pageFitMode) { case 4: a = this._stretchToAvoidPageMargins(); b.width = a.width; b.height = a.height; break; case 5: break; default: b.width < a.width && (this._stretchToWidth(b.width, a.width), b.width = a.width), b.height < a.height && (b.height = a.height) } switch (this.options.orientationType) { case 2: case 3: b.invert() } this.m_placeholder.css(b.getCSS());
...
primitives.orgdiagram.BaseController.prototype._getChildrenOffset = function (a) {
    var b = a.offset + a.actualSize.width / 2, c = null, d, e; if (null === a.visualAggregatorId) switch (d = null, this._visualTree.loopChildren(this, a.id, function (a, b) { d = b; if (d.connectorPlacement & 1) return !0 }), e = null, this._visualTree.loopChildrenReversed(this, a.id, function (a, b) { e = b; if (e.connectorPlacement & 1) return !0 }), this.options.horizontalAlignment) {
        case 1: c = d.offset + d.actualSize.width / 2; break; case 2: c = e.offset + e.actualSize.width / 2; break; case 0: c =
        (d.offset + e.offset + e.actualSize.width) / 2
    } else a = this._visualTree.node(a.visualAggregatorId), c = a.offset + a.actualSize.width / 2; return b - c
}; primitives.orgdiagram.BaseController.prototype._offsetItem = function (a, b) { a.offset += b; var c = this._treeLevels[a.level]; c.currentOffset = Math.max(c.currentOffset, a.offset + a.actualSize.width) };
...
primitives.orgdiagram.BaseController.prototype._recalcLevelsDepth = function () {
    var a, b, c, d, e, f, g, h, j, i, k; a = 0; for (b = this._treeLevels.length; a < b; a += 1) { g = this._treeLevels[a]; f = g.treeItems; c = 0; for (d = f.length; c < d; c += 1); } a = 0; for (b = this._treeLevels.length; a < b; a += 1) {
        g = this._treeLevels[a]; g.shift = 0; g.depth = 0; g.partnerConnectorOffset = 0; g.actualVisibility = 4; f = g.treeItems; j = []; k = i = null; c = 0; for (d = f.length; c < d; c += 1) {
            e = this._visualTree.node(f[c]); g.depth = Math.max(g.depth, e.actualSize.height); switch (e.actualVisibility) {
                case 2: case 3: case 4: k =
                !k ? e.actualSize.height : Math.min(k, e.actualSize.height); break; default: i = !i ? e.actualSize.height : Math.min(i, e.actualSize.height)
            } g.actualVisibility = Math.min(g.actualVisibility, e.actualVisibility); (0 < e.partners.length || 0 < e.extraPartners.length) && j.push(new primitives.common.StackSegment(e))
        } null == i && (i = g.depth); null != k && k > i && (i = k); switch (this.options.verticalAlignment) {
            case 0: g.horizontalConnectorsDepth = i / 2; break; case 1: g.horizontalConnectorsDepth = g.depth / 2; break; case 2: g.horizontalConnectorsDepth = g.depth -
            i / 2
        } if (0 < j.length) { c = 0; for (d = j.length; c < d; c += 1) { i = j[c]; k = i.context.partners.slice(0).concat(i.context.extraPartners); e = 0; for (f = k.length; e < f; e += 1) h = this._visualTree.node(k[e]), h = h.offset + h.actualSize.width / 2, i.startIndex = null != i.startIndex ? Math.min(i.startIndex, h) : h, i.endIndex = null != i.endIndex ? Math.max(i.endIndex, h) : h } g.partnerConnectorOffset = primitives.common.stackSegments(j, function (a, b) { a.context.partnerConnectorOffset = b }) }
    }
};
...
primitives.orgdiagram.BaseController.prototype._onGroupTitleTemplateRender = function (a, b) {
    var c = new primitives.text.Config, d = null != b.itemConfig.groupTitleColor ? b.itemConfig.groupTitleColor : "#4169e1"; c.orientation = 2; c.horizontalAlignment = 0; c.verticalAlignment = 1; c.text = b.itemConfig.groupTitle; c.fontSize = "12px"; c.color = primitives.common.highestContrast(d, this.options.itemTitleSecondFontColor, this.options.itemTitleFirstFontColor); c.fontFamily = "Arial"; switch (b.renderingMode) {
        case 0: b.element.bpText(c);
            break; case 1: b.element.bpText("option", c), b.element.bpText("update")
    } primitives.common.css(b.element, { background: d })
}; primitives.orgdiagram.BaseController.prototype._createButtonsTemplate = function () { var a = jQuery("<ul></ul>"); a.css({ position: "absolute" }).addClass("ui-widget ui-helper-clearfix"); this._buttonsTemplate = a.wrap("<div>").parent().html(); this._buttonsTemplateHashCode = primitives.common.hashCode(this._buttonsTemplate) };
primitives.orgdiagram.BaseController.prototype._onButtonsTemplateRender = function (a, b) {
    var c = 0, d, e, f, g; switch (b.renderingMode) {
...
primitives.orgdiagram.BaseController.prototype._createVisualTree = function () {
    this._defaultTemplate = this._highlightTreeItem = this._cursorTreeItem = null; this._defaultTemplate = this._templates[this.options.defaultTemplateName]; void 0 === this._defaultTemplate && (this._defaultTemplate = this._templates[this.widgetEventPrefix + "Template"]); this._visualTree = primitives.common.tree(); this._treeItemCounter = 0; this._treeItemsByUserId = {}; this._navigationFamily = primitives.common.family(); this._treeLevels = []; this._leftMargins =
...
primitives.orgdiagram.BaseController.prototype._createVisualTreeItems = function () {
    var a, b, c, d, e, f, g, h, j, i, k, l, m = {}, n, p = {}, r, s, q, t = {}, u; this._orgTree.loopPostOrder(this, function (a, b, c, d) { b.hasVisibleChildren = b.isVisible || b.hasVisibleChildren; null != d && (d.hasVisibleChildren = d.hasVisibleChildren || b.hasVisibleChildren) }); this._orgTree.loopLevels(this, function (c, g) {
        var i, h, j; if (!this.showInvisibleSubTrees && !g.hasVisibleChildren) return this._orgTree.SKIP; i = this._treeItemsByUserId[c]; i || (i = this._getNewTreeItem({
            visibility: 4,
            connectorPlacement: 0, parentId: null, orgItem: g, itemConfig: null, actualItemType: 0
        }), this._visualTree.add(null, i.id, i)); q = s = 0; if (null != (f = this._visualTree.indexOf(i.id))) s = f, q = this._visualTree.countSiblings(i.id) - f - 1; h = []; this._orgTree.loopChildren(this, c, function (c, f) {
            if (this.showInvisibleSubTrees || f.hasVisibleChildren) {
                a = this._getNewTreeItem({ orgItem: f, itemConfig: f.context, parentId: i.id, actualItemType: f.itemType }); a.visibility = !a.orgItem.isVisible ? 4 : 0; switch (i.actualItemType) {
                    case 7: case 8: case 6: switch (a.actualItemType) {
                        case 7: case 8: case 6: a.actualItemType =
                        2; break; case 0: a.actualItemType = 1
                    }
                    ...
                    this._visualTree.parent(i.id); if (i.connectorPlacement & 2) this._visualTree.add(b.id, a.id, a, s), a.connectorPlacement = 6, a.gravity = 2; else if (i.connectorPlacement & 8) this._visualTree.add(b.id, a.id, a, this._visualTree.countChildren(b.id) - q), a.connectorPlacement = 12, a.gravity = 1; else {
                        switch (f.adviserPlacementType) { case 2: this._visualTree.add(b.id, a.id, a, s); a.gravity = 2; break; default: this._visualTree.add(b.id, a.id, a, this._visualTree.countChildren(b.id) - q), a.gravity = 1 } switch (a.actualItemType) {
                            case 6: a.connectorPlacement =
                            5; break; case 7: a.connectorPlacement = 4
                        }
            ...
            case 7: case 8: case 6: break; default: u = [], null != (b = this._visualTree.parent(i.id)) && this._visualTree.loopChildrenRange(this, b.id, s, this._visualTree.countChildren(b.id) - q, function (a, b) { if (b.id == i.id) u.push(b); else switch (b.actualItemType) { case 7: case 8: case 6: this._orgTree.parentid(b.orgItem.id) == i.orgItem.id && u.push(b) } }),
            1 < u.length && (t[i.id] = u)
        } m[i.id] = []; p[i.id] = []; this._layoutChildren(i, h, i.orgItem.childrenPlacementType, m[i.id], p[i.id])
    }); this._orgTree.loopPostOrder(this, function (a) {
        var a = this._treeItemsByUserId[a], b, d, e; if (null != a) {
            b = p[a.id]; d = m[a.id]; i = this._getAssitantsDepth(a); if (0 < i && (a.visualDepth = i + 1, null !== a.visualAggregatorId)) { c = this._visualTree.node(a.visualAggregatorId); e = this._visualTree.hasChildren(c.id); for (f = 0; f < i - 1; f += 1) c = this._createNewVisualAggregator(c, !e) } i = this._getAdvisersDepth(a); if (1 < i) {
                a.visualDepth +=
                i - 1; e = this._visualTree.hasChildren(a.id); c = a; for (f = 0; f < i - 1; f += 1) c = this._createNewVisualAggregator(c, !e)
...
primitives.orgdiagram.BaseController.prototype._layoutPartners = function (a, b) {
    var c, d, e, f, g = 0, h = [], j, i; d = 0; for (e = b.length; d < e; d += 1) c = b[d], g = Math.max(g, c.visualDepth); d = 0; for (e = b.length; d < e; d += 1) { c = b[d]; j = this._getLastVisualAggregator(c); f = 1; for (i = c; null != i.visualAggregatorId;) i = this._visualTree.node(i.visualAggregatorId), i.connectorPlacement = 5, f += 1; for (; f < g;) j = this._createNewVisualAggregator(j, !1), f += 1; h.push(this._getLastVisualAggregator(j).id) } i = this._getLastVisualAggregator(a); if (this._visualTree.hasChildren(i.id)) {
        ...
        function (b, d) { switch (d.actualItemType) { case 5: case 2: case 4: case 1: break; default: a.id != c.id && this._defineNavigationParent(c, d) } return this._navigationFamily.SKIP }); j = this._getLastVisualAggregator(j); this._visualTree.moveChildren(i.id, j.id)
    } j.partners = h; a.partnerAggregatorId = j.id
...
primitives.orgdiagram.BaseController.prototype._layoutChildren = function (a, b, c, d, e) {
    var f, g, h, j, i, k, l, m, n = 4 == a.visibility && 0 == a.connectorPlacement; switch (this.options.horizontalAlignment) { case 0: case 1: g = 3; break; case 2: g = 2 } 0 === c && (c = this._hasRegularLeavesOnly(this._orgTree, a) ? 0 === this.options.leavesPlacementType ? 3 : this.options.leavesPlacementType : 0 === this.options.childrenPlacementType ? 2 : this.options.childrenPlacementType); f = a; null !== a.visualAggregatorId && (f = this._visualTree.node(a.visualAggregatorId));
    3 == c && 3 > b.length && (c = 2); switch (c) {
        case 2: c = 0; for (j = b.length; c < j; c += 1) a = b[c], this._visualTree.add(f.id, a.id, a), a.connectorPlacement = (a.orgItem.hideParentConnection ? 0 : 1) | (a.orgItem.hideChildrenConnection ? 0 : 4), 0 == c && (a.relationDegree = 1); break; case 3: j = Math.min(this.options.maximumColumnsInMatrix, Math.ceil(Math.sqrt(b.length))); i = Math.ceil(b.length / j); k = Math.ceil(j / 2); for (l = 0; l < k; l += 1) {
            g = f; for (m = 0; m < i; m += 1) {
                a = this._getMatrixItem(b, 2 * l, m, j); c = this._getMatrixItem(b, 2 * l + 1, m, j); void 0 === d[m] && (d[m] = [], e[m] =
                []); null !== a && (0 == l && (a.relationDegree = 1), this._visualTree.add(g.id, a.id, a), a.connectorPlacement = (n ? 0 : 2) | 4, a.gravity = 2, e[m].push(a)); if (null !== a || null !== c) h = this._getNewTreeItem({ visibility: 4, connectorPlacement: n ? 0 : 5 }), this._visualTree.add(g.id, h.id, h), d[m].push(h); null !== c && (this._visualTree.add(g.id, c.id, c), c.connectorPlacement = (n ? 0 : 8) | 4, c.gravity = 1, e[m].push(c)); g = h
            }
        } 2 < j && (f.visualAggregatorId = null); break; case 1: c = 0; for (j = b.length; c < j; c += 1) {
            a = b[c]; h = this._getNewTreeItem({
                visibility: 4, connectorPlacement: n ?
                0 : 5
            }); f.visualAggregatorId = h.id; switch (g) { case 2: this._visualTree.add(f.id, a.id, a); this._visualTree.add(f.id, h.id, h); a.connectorPlacement = (n ? 0 : 2) | 4; a.gravity = 2; break; case 3: this._visualTree.add(f.id, h.id, h), this._visualTree.add(f.id, a.id, a), a.connectorPlacement = (n ? 0 : 8) | 4, a.gravity = 1 } d[c] = [h]; e[c] = [a]; f = h
        }
    }
}; primitives.orgdiagram.BaseController.prototype._getMatrixItem = function (a, b, c, d) { 0 < d % 2 && (b === d - 1 ? b = a.length : b === d && (b = d - 1)); b = c * d + b; return b > a.length - 1 ? null : a[b] };
...
primitives.orgdiagram.BaseController.prototype._findLeftSiblingIndex = function (a) {
    var b = null, c = {}, d = this._visualTree.parent(a.id); this._visualTree.loopChildrenReversed(this, d.id, function (d, f, g) {
        if (null === b) d == a.id && (b = -1, c[a.id] = !0, this._navigationFamily.loopChildren(this, a.id, function (a, b, d) { if (0 < d) return this._navigationFamily.BREAK; c[a] = !0 })); else if (c.hasOwnProperty(d)) this._navigationFamily.loopChildren(this, f.id, function (a, b, d) { if (0 < d) return this._navigationFamily.BREAK; c[a] = !0 }); else return b =
        g, !0
    }); return b
};
primitives.orgdiagram.BaseController.prototype._findRightSiblingIndex = function (a) {
    ...
    return b
}; primitives.orgdiagram.BaseController.prototype._createNewVisualAggregator = function (a, b) { var c; c = this._getNewTreeItem({ visibility: 4, visualAggregatorId: a.visualAggregatorId, connectorPlacement: 4 == a.visibility && 0 == a.connectorPlacement || b ? 0 : 5 }); this._visualTree.insert(a.id, c.id, c); a.visualAggregatorId = c.id; return c };
...
primitives.orgdiagram.BaseController.prototype._showSelectedItems = function () {
    ...
    null != a && (a.isSelected = !0, !e[a.id])) switch (0 === a.visibility && (a.visibility = 1), this.options.selectionPathMode) { case 1: this._navigationFamily.loopParents(this, a.id, function (a, b) { if (null != e[a]) return this._navigationFamily.SKIP; e[a] = !0; 0 === b.visibility && (b.visibility = 1) }) }
...
primitives.common.perimeter.Manager = function (a) {
    function b(a) { var b, g, h; b = 0; for (g = a.length; b < g; b += 1) h = a[b], c[h.id] = h, h.segments.iterate(function (a) { d[a.key] = h }) } var c = {}, d = {}; null != a && b(a); return {
        add: b, getMergedPerimeters: function (a) {
            var b = [], g = {}, h, j, i, k, l, m; h = 0; for (j = a.length; h < j; h += 1) i = a[h], g[i] = !c.hasOwnProperty(i); h = 0; for (j = a.length; h < j; h += 1) if (i = a[h], !g[i]) {
                g[i] = !0; k = new primitives.common.perimeter.Item(i); i = c[i]; i.segments.iterate(function (a) { k.segments.add(a.key, a) }); b.push(k); for (l = k.segments.startKey() ; null !=
                l;) {
                    m = k.segments.item(l); d.hasOwnProperty(m.oppositeKey) && (i = d[m.oppositeKey], g.hasOwnProperty(i.id) && !g[i.id] && (g[i.id] = !0, i.segments.iterateBack(function (a) { a.key != m.oppositeKey && k.segments.insertAfter(l, a.key, a) }, m.oppositeKey, null), i.segments.iterateBack(function (a) { k.segments.insertAfter(l, a.key, a) }, null, m.oppositeKey))); i = k.segments; for (var n = m, p = i.nextKey(n.key), r = void 0; null != n && n.oppositeKey == (r = p || i.startKey()) ;) null != p && (p = i.nextKey(p)), i.remove(n.key), i.remove(r), n = i.item(null != p ? i.prevKey(p) :
                    i.endKey()); l = p
                }
            } return b
        }
...
primitives.common.mergeSort = function (a, b, c) {
    var d = null, e, f, g, h, j, i, k, l, m, n, p, r; switch (a.length) {
        case 0: d = []; break; default: d = []; for (g = 0; g < a.length; g += 1) {
            e = a[g]; f = []; i = d.length; k = e.length; j = h = 0; p = m = n = l = null; 0 < i && (l = d[h], n = !b ? l : b(l)); 0 < k && (m = e[j], p = !b ? m : b(m)); for (r = null; h < i || j < k;) if (h >= i) { if (!c || r != m) f.push(m), r = m; j += 1; j < k && (m = e[j], p = !b ? m : b(m)) } else if (j >= k) { if (!c || r != l) f.push(l), r = l; h += 1; h < i && (l = d[h], n = !b ? l : b(l)) } else if (n < p) { if (!c || r != l) f.push(l), r = l; h += 1; h < i && (l = d[h], n = !b ? l : b(l)) } else {
                if (!c || r != m) f.push(m),
                r = m; j += 1; j < k && (m = e[j], p = !b ? m : b(m))
            } d = f
        }
    } return d
};
primitives.common.stackSegments = function (a, b) {
    var c = 0, d, e, f, g, h, j, i, k = [], l, m, n, p, r, s, q = {}; a.sort(function (a, b) { return a.endIndex - a.startIndex - (b.endIndex - b.startIndex) }); g = 0; for (h = a.length; g < h; g += 1) {
        f = a[g]; e = d = 0; n = f.startIndex; q[n] = d + 1; p = f.endIndex; q[p] = e; i = k.length; if (0 < i) {
            l = []; s = r = !1; for (j = 0; j < i; j += 1) m = k[j], m < n ? (l.push(m), d = q[m], e = q[m]) : m < p ? (r || (l.push(n), r = !0), d = Math.max(d, q[m]), e = q[m]) : (r || (l.push(n), r = !0), s || (l.push(p), s = !0, q[n] = d + 1, q[p] = e), l.push(m)); r || (l.push(n), r = !0); s || (l.push(p), s = !0, q[n] =
            d + 1, q[p] = e); k = l
        } else k = [n, p]; b(f, q[n]); c = Math.max(c, q[n])
    } return c
}; primitives.common.binarySearch = function (a, b) { var c = null, d, e, f = 0, g = a.length - 1, h, j; if (0 < a.length && (c = a[f], d = b(c), 0 < d)) if (e = Math.abs(d), j = a[g], d = b(j), 0 <= d) c = j; else { d = Math.abs(d); e > d && (e = d, c = j); for (; f + 1 < g;) if (h = Math.round((f + g) / 2), j = a[h], d = b(j), 0 == d) { c = j; break } else 0 < d ? f = h : g = h, d = Math.abs(d), e > d && (e = d, c = j) } return c };
primitives.common.family = function () {
    function a(a, b, c, d) { var e; if (null != d && (b = b[c], null != b)) for (e in b) if (b.hasOwnProperty(e) && d.call(a, e)) break } function b(a, b) { var c = !1; null != s[a] && null != s[a][b] && (delete s[a][b], q[a] -= 1, delete t[b][a], u[b] -= 1, q[a] || (delete s[a], delete q[a]), t[b] || (delete t[b], delete u[b], null == p[null] && (p[null] = {}, r[null] = 0), p[null][b] = !0, r[null] += 1), c = !0); return c } function c(a, b) { var c; if (null != b) for (c in v) if (v.hasOwnProperty(c) && b.call(a, c, v[c])) break } function d(b, c, d, e) {
        for (var f,
        g, i = {}, h = 0, j = !0; j;) { f = {}; j = !1; for (g in d) if (d.hasOwnProperty(g) && !i[g]) switch (i[g] = !0, e.call(b, g, v[g], h)) { case x: f = {}; j = !1; break; case w: break; default: a(this, c, g, function (a) { i[a] || (j = f[a] = !0) }) } d = f; h += 1 }
    } function e(a, b, c) { null != c && null != b && (null != v[b] && null != s[b]) && d(a, s, s[b], c) } function f(a, b, c) { null != c && null != b && (null != v[b] && null != t[b]) && d(a, t, t[b], c) } function g(b, c, d, e, f, g) {
        var i, h, j, k; if (null != g) {
            c = []; h = {}; for (i in v) v.hasOwnProperty(i) && (h[i] = d[i] || 0, h[i] || c.push(i)); for (k = 0; 0 < c.length;) {
                j = [];
                d = 0; for (f = c.length; d < f; d += 1) { i = c[d]; if (g.call(b, i, v[i], k)) { j = []; break } k += 1; a(this, e, i, function (a) { h[a] -= 1; 0 == h[a] && j.push(a) }) } c = j
            }
        }
    } function h(a, b) { g(a, t, u, s, q, b) } function j(a, b) { g(a, s, q, t, u, b) } function i(a, b, c, d, e, f, g, i, h) {
        var j = !1, k, l; if (null != v[a] && null != g[a]) {
            j = !0; if (h) { h = 0; for (k = b.length; h < k; h += 1) if (l = b[h], null == v[l] || null == g[a][l]) j = !1 } if (j && (null != d && (v[c] = d), null != v[c])) {
                e[c] || (e[c] = {}, f[c] = 0); g[c] || (g[c] = {}, i[c] = 0); e[c][a] || (e[c][a] = !0, f[c] += 1); g[a][c] || (g[a][c] = !0, i[a] += 1); h = 0; for (k = b.length; h <
                k; h += 1) l = b[h], c != l && (null != g[a][l] && (delete g[a][l], i[a] -= 1), null != e[l][a] && (delete e[l][a], f[l] -= 1), e[l][c] || (e[l][c] = !0, f[l] += 1), g[c][l] || (g[c][l] = !0, i[c] += 1))
            }
        } return j
    } function k(a, b, c, d) { return i(a, b, c, d, t, u, s, q, !0) } function l() { this.key = this.id = ""; this.children = []; this.childrenHash = {}; this.processed = !1 } function m(a) { this.items = []; this.difference = this.weight = 0; 0 < arguments.length && (this.difference = a) } function n(b) {
        var c = primitives.common.graph(), d, e, f, g, i, h, j, k, l = {}; for (d in b) b.hasOwnProperty(d) &&
    ...
    } var p = {}, r = {}, s = {}, q = {}, t = {}, u = {}, v = {}, x = 1, w = 2; return {
        add: function (b, c, d) {
            var e, f, g = {}; if (!b || 0 == b.length) b = [null]; if (null == v[c] && null != d) {
                v[c] =
                d; d = 0; for (e = b.length; d < e; d += 1) f = b[d], null == g[f] && f != c && (g[f] = !0, null != v[f] ? (null == t[c] && (t[c] = {}, u[c] = 0), t[c][f] || (t[c][f] = !0, u[c] += 1), null == s[f] && (s[f] = {}, q[f] = 0), s[f][c] || (s[f][c] = !0, q[f] += 1)) : (null == p[f] && (p[f] = {}, r[f] = 0), p[f][c] || (p[f][c] = !0, r[f] += 1))); null != p[c] && (s[c] = p[c], q[c] = r[c], delete p[c], delete r[c], a(this, s, c, function (a) { null == t[a] && (t[a] = {}, u[a] = 0); t[a][c] || (t[a][c] = !0, u[a] += 1) }))
            }
        }, adopt: function (a, b) {
            var c, d, e; if (null != v[b]) {
                c = 0; for (d = a.length; c < d; c += 1) if (e = a[c], null == t[b] && (t[b] =
                {}, u[b] = 0), e != b && null != v[e]) t[b][e] || (t[b][e] = !0, u[b] += 1), null == s[e] && (s[e] = {}, q[e] = 0), s[e][b] || (s[e][b] = !0, q[e] += 1); else throw "Item cannot be parent of itself and parent should exist in the structure!";
            } else throw "Child should be in hierarchy!";
        }, bundleChildren: k, bundleParents: function (a, b, c, d) { return i(a, b, c, d, s, q, t, u, !0) }, optimizeReferences: function (b) {
            var c = {}, d = {}, f = {}, g, h, j, k, m, p; if (null != b) {
                for (g in v) v.hasOwnProperty(g) && (h = new l, a(this, s, g, function (a) {
                    h.children.push(a); h.childrenHash[a] =
                    !0
                }), h.children.sort(), h.id = g, h.key = h.children.join(","), f[h.id] = h); for (; !primitives.common.isEmptyObject(f) ;) {
                    j = {}; k = n(f); for (g in f) f.hasOwnProperty(g) && (m = f[g], m.processed || (p = k.getSpanningTree(g, function (a, b) { return a.weight > b.weight ? 1 : a.weight == b.weight ? b.difference - a.difference : -1 }), p.loopLevels(this, function (a, g) {
                        f[a].processed = !0; p.loopChildren(this, a, function (h, m) {
                            var n = k.edge(a, h), p = null, r, A, L, y, H; f[h].processed = !0; if (1 < n.weight) {
                                A = n.items.join(","); if (c.hasOwnProperty(A)) p = c[A]; else {
                                    r =
                                    b(); v[r.id] = r; p = new l; p.id = r.id; p.key = A; A = 0; for (L = n.items.length; A < L; A += 1) p.children.push(n.items[A]), p.childrenHash[n.items[A]] = !0; p.children.sort(); c[p.key] = p; d[p.id] = p; j[p.id] = p; y = p.children.slice(0); e(this, g.replacementItem || a, function (a) { null != d[a] && !p.childrenHash[a] && (H = !0, e(this, a, function (a) { return !p.childrenHash[a] ? (H = !1, x) : w }), H && y.push(a)); return w }); i(g.replacementItem || a, y, p.id, r, t, u, s, q, !1); if (1 >= (q[a] || 0)) g.replacementItem = p.id
                                } if (p.id != h && (y = p.children.slice(0), e(this, m.replacementItem ||
                                h, function (a) { null != d[a] && !p.childrenHash[a] && (H = !0, e(this, a, function (a) { return !p.childrenHash[a] ? (H = !1, x) : w }), H && y.push(a)); return w }), i(m.replacementItem || h, y, p.id, null, t, u, s, q, !1), 1 >= (q[h] || 0))) m.replacementItem = p.id
                            }
                        })
                    }))); f = j
                }
            }
        }, eliminateManyToMany: function (b) { var c, d; for (c in s) s.hasOwnProperty(c) && 1 < (q[c] || 0) && a(this, s, c, function (a) { if (1 < (u[a] || 0)) d = b(), k(c, [a], d.id, d) }) }, removeNode: function (b) {
            null != v[b] && (a(this, s, b, function (a) {
                delete t[a][b]; u[a] -= 1; u[a] || (delete t[a], delete u[a], null ==
                p[null] && (p[null] = {}, r[null] = 0), p[null][a] || (p[null][a] = !0, r[null] += 1))
            }), a(this, t, b, function (a) { delete s[a][b]; q[a] -= 1; q[a] || (delete s[a], delete q[a]) }), null != p[null] && null != p[null][b] && (delete p[null][b], r[null] -= 1, r[null] || (delete p[null], delete r[null])), delete s[b], delete q[b], delete t[b], delete u[b], delete v[b])
        }, removeRelation: function (a, c) { var d = !1; null != v[a] && null != v[c] && (d = b(a, c) || b(c, a)); return d }, node: function (a) { return v[a] }, loop: c, loopLevels: function (b, c, d) {
            function e() {
                this.items = {};
                this.minimumLevel = null
            } function f(a, b, c) { var d = n[b]; d || (d = new e, n[b] = d); d.addItemToLevel(a, c); w = null == w ? c : Math.min(w, c); m[a] = c; k[a] = !0 } var g = [], i = {}, k = {}, l = [], m = {}, n = {}, p, r, q, u, x, w = null; q = c ? h : j; var J, D, y, F, B, E, K, I; e.prototype.addItemToLevel = function (a, b) { var c = this.items[b]; c ? c.push(a) : (c = [a], this.items[b] = c); this.minimumLevel = null == this.minimumLevel ? b : Math.min(this.minimumLevel, b) }; if (null != d) {
                q(this, function (a, b, c) { g.push(a); i[a] = c }); q = 0; for (J = g.length; q < J; q += 1) if (p = g[q], null == k[p]) {
                    l.push(p); for (f(p,
                    q, 0) ; 0 < l.length;) {
                        B = F = y = null; E = !c; K = []; p = 0; for (u = l.length; p < u; p += 1) x = l[p], D = m[x], I = !1, c ? (a(this, t, x, function (a) { var b; if (!k[a] && (I = !0, b = i[a], null == y || !E || y < b || y == b && B > D - 1)) y = b, F = a, B = D - 1, E = !0 }), a(this, s, x, function (a) { var b; if (!k[a] && (I = !0, b = i[a], null == y || !E && (y > b || y == b && B < D + 1))) y = b, F = a, B = D + 1, E = !1 })) : (a(this, s, x, function (a) { var b; if (!k[a] && (I = !0, b = i[a], null == y || E || y < b || y == b && B < D + 1)) y = b, F = a, B = D + 1, E = !1 }), a(this, t, x, function (a) {
                            var b; if (!k[a] && (I = !0, b = i[a], null == y || E && (y > b || y == b && B > D - 1))) y = b, F = a, B = D - 1,
                            E = !0
                        })), I && K.push(x); null != F && (K.push(F), f(F, q, B)); l = K
                    }
                } l = !0; for (c = w; l;) { p = {}; l = !1; for (r in n) if (n.hasOwnProperty(r) && (q = n[r], u = q.items[q.minimumLevel - w + c], null != u)) { p[r] = q; l = !0; q = 0; for (J = u.length; q < J; q += 1) if (x = u[q], d.call(b, x, v[x], c - w)) return l = !1, !0 } n = p; c += 1 }
            }
        }, loopTopo: h, loopTopoReversed: j, loopChildren: e, loopParents: f, findLargestRoot: function () {
            var a = null, b, c = {}, d = {}, e; b = null; j(this, function (g, i) {
                c.hasOwnProperty(g) || (c[g] = {}, d[g] = 0); c[g][g] = !0; d[g] += 1; e = !0; f(this, i.id, function (a) {
                    var b, f; e = !1;
                    c.hasOwnProperty(a) || (c[a] = {}, d[a] = 0); if (!d[a] && 1 == u[g]) c[a] = c[g], d[a] = d[g]; else for (f in b = c[g], b) b.hasOwnProperty(f) && (c[a][f] = !0, d[a] += 1); return w
                }); if (e && (!b || d[g] > b)) b = d[g], a = g
            }); return a
        }, loopRoots: function (a, b) {
            var c = null, d, e = 0, g = {}, i = {}, h, k = {}, l = {}, m, n, p, q, r, s, t; j(this, function (a, b) {
                g.hasOwnProperty(a) || (g[a] = {}, i[a] = 0); g[a][a] = !0; i[a] += 1; h = !0; f(this, b.id, function (b) {
                    var c, d; h = !1; g.hasOwnProperty(b) || (g[b] = {}, i[b] = 0); if (!i[b] && 1 == u[a]) g[b] = g[a], i[b] = i[a]; else for (d in c = g[a], c) c.hasOwnProperty(d) &&
                    !g[b][d] && (g[b][d] = !0, i[b] += 1); return w
                }); h && (k[a] = !0, e += 1)
            }); q = {}; for (p in k) if (k.hasOwnProperty(p)) for (n in d = g[p], d) d.hasOwnProperty(n) && (q[n] || (q[n] = []), q[n].push(p.toString())); for (; 0 < e;) { d = null; for (m in k) if (k.hasOwnProperty(m) && (!d || i[m] < d)) d = i[m], c = m; if (null != c) { null != b && b.call(a, c, v[c]); d = g[c]; for (n in d) if (d.hasOwnProperty(n) && !l[n]) { p = q[n]; s = 0; for (t = p.length; s < t; s += 1) r = p[s], i[r] -= 1; l[n] = !0 } delete k[c]; e -= 1 } }
        }, hasNodes: function () { return !primitives.common.isEmptyObject(v) }, hasCommonChild: function (b) {
            var c =
            !1, d, e, f, g, i, h, j; d = {}; g = f = 0; for (i = b.length; g < i; g += 1) h = b[g], null != v[h] && !d[h] && (d[h] = !0, f += 1); e = {}; for (h in d) d.hasOwnProperty(h) && a(this, s, h, function (a) { e[a] = e[a] ? e[a] + 1 : 1 }); for (j in e) if (e.hasOwnProperty(j) && null != t[j] && (u[j] || 0) == e[j] && e[j] == f) { c = !0; break } return c
        }, loopNeighbours: function (a, b, c) {
            var d = {}; null != c && (e(this, b, function (b, e) { d.hasOwnProperty(b) || (d[b] = null, c.call(a, b, e, 1) && (d[b] = w, f(this, b, function (b, e) { d.hasOwnProperty(b) || (d[b] = null, c.call(a, b, e, 2) && (d[b] = w)); return d[b] }))); return d[b] }),
            f(this, b, function (b, f) { d.hasOwnProperty(b) || (d[b] = null, c.call(a, b, f, 1) && (d[b] = w, e(this, b, function (b, e) { d.hasOwnProperty(b) || (d[b] = !0, c.call(a, b, e, 2) && (d[b] = w)); return d[b] }))); return d[b] }))
        }, countChildren: function (a) { return q[a] || 0 }, countParents: function (a) { return u[a] || 0 }, firstParent: function (a) { var b = null, a = t[a] || {}; for (b in a) if (a.hasOwnProperty(b)) return b; return null }, firstChild: function (a) { var b = null, a = s[a] || {}; for (b in a) if (a.hasOwnProperty(b)) return b; return null }, validate: function (b) {
            function d(a) {
                var b =
                0, c; if (null != a) for (c in a) a.hasOwnProperty(c) && (b += 1); return b
            } var e, f; c(this, function (c) { a(this, s, c, function (a) { if (!t.hasOwnProperty(a) || !t[a].hasOwnProperty(c)) return null != b && (b.message = "Child #" + a + " does not reference parent #" + c), !1 }); a(this, t, c, function (a) { if (!s.hasOwnProperty(a) || !s[a].hasOwnProperty(c)) return null != b && (b.message = "Parent #" + a + " does not reference child #" + c), !1 }) }); for (e in t) if (t.hasOwnProperty(e)) {
                if ((u[e] || 0) != d(t[e])) return null != b && (b.message = "Parents count for item #" +
                e + " missmatch."), !1; if (t.hasOwnProperty(e) && !v.hasOwnProperty(e)) return null != b && (b.message = "Orphant parents for item #" + e), !1
            } for (f in s) if (s.hasOwnProperty(f)) { if ((q[f] || 0) != d(s[f])) return null != b && (b.message = "Children count for item " + f + " missmatch."), !1; if (s.hasOwnProperty(f) && !v.hasOwnProperty(f)) return null != b && (b.message = "Orphant children of item " + f), !1 } for (f in p) if (p.hasOwnProperty(f)) {
                if ((r[f] || 0) != d(p[f])) return null != b && (b.message = "Root children count for item @" + f + " missmatch."), !1;
                a(this, p, f, function (a) { if (!v.hasOwnProperty(a)) return null != b && (b.message = "Child #" + a + "of root #" + f + " does not exists."), !1 })
            } return !0
        }, clone: function () { var a = primitives.common.family(); c(this, function (b, c) { var d = []; f(this, b, function (a) { d.push(a); return w }); a.add(d, b, c) }); return a }, BREAK: x, SKIP: w
    }
};
primitives.common.graph = function () {
    var a = {}; return {
        addEdge: function (b, c, d) { if ((null == a[b] || null == a[b][c]) && null != d) null == a[b] && (a[b] = {}), a[b][c] = d, null == a[c] && (a[c] = {}), a[c][b] = d }, edge: function (b, c) { var d = null; null != a[b] && a[b][c] && (d = a[b][c]); return d }, getSpanningTree: function (b, c) {
            var d = primitives.common.tree(), e = {}, f, g = [], h, j = {}, i, k, l, m, n, p, r; e[b] = !0; i = 1; j[b] = null; for (d.add(null, b.toString(), {}) ; 0 < i;) {
                g = []; m = l = k = null; for (f in e) if (e.hasOwnProperty(f)) {
                    n = a[f]; h = !1; for (p in n) if (n.hasOwnProperty(p) &&
                    !j.hasOwnProperty(p) && (r = n[p], h = !0, !l || 0 <= c(r, l))) k = p, l = r, m = f; h || g.push(f)
                } if (null == k) break; else e[k] = !0, i += 1, j[k] = m, d.add(m, k, {}); h = 0; for (k = g.length; h < k; h += 1) delete e[g[h]], i -= 1
            } return d
        }, getGrowthSequence: function (b) {
            var c = [], d, e = {}, f; d = []; var g, h = {}, j = 0, i, k, l, m, n, p; if (null != b) {
                d = null; l = 0; m = null; for (g in a) if (a.hasOwnProperty(g)) { k = a[g]; l = 0; for (i in k) k.hasOwnProperty(i) && (l += b(k[i])); if (l > m || null == m) d = g, m = l } if (null != d) {
                    c.push(d); e[d] = !0; j += 1; for (h[d] = null; 0 < j;) {
                        d = []; k = i = null; l = {}; for (f in e) if (e.hasOwnProperty(f)) {
                            m =
                            a[f]; g = !1; for (n in m) if (m.hasOwnProperty(n) && !h.hasOwnProperty(n) && (p = b(m[n]), g = !0, null == l[n] && (l[n] = 0), l[n] += p, !k || l[n] > k)) i = n, k = l[n]; g || d.push(f)
                        } if (null == i) break; else e[i] = !0, j += 1, h[i] = !0, c.push(i); g = 0; for (i = d.length; g < i; g += 1) delete e[d[g]], j -= 1
                    }
                }
            } return c
        }, getShortestPath: function (b, c, d) {
            var e = {}, f = {}, g = {}, h, j, i, k, l; e[b] = !0; h = 1; for (f[b] = 0; 0 < h;) {
                j = b = null; for (i in e) e.hasOwnProperty(i) && (null == j ? (b = i, j = f[i]) : j > f[i] && (b = i, j = f[i])); k = a[b]; for (i in k) k.hasOwnProperty(i) && (l = j + (null != d ? d(k[i], b, i) :
                1), f.hasOwnProperty(i) ? f[i] > l && e.hasOwnProperty(i) && (f[i] = l, g[i] = b) : (f[i] = l, g[i] = b, e[i] = !0, h += 1)); if (b == c) break; else delete e[b], h -= 1
            } for (d = []; null != c;) d.push(c), c = g[c]; return d
        }
    }
};
primitives.common.LinkedHashItems = function () {
    function a(a, b) { if (e.hasOwnProperty(a)) throw "Duplicate segments are not supported!"; e[a] = b; f[a] = null; null == j ? (h = a, g[a] = null) : (f[j] = a, g[a] = j); j = a } function b(a, b) { if (e.hasOwnProperty(a)) throw "Duplicate segments are not supported!"; e[a] = b; g[a] = null; null == h ? (j = a, f[a] = null) : (g[h] = a, f[a] = h); h = a } function c(a, b, c, d) { var n; null == c && (c = a ? h : j); if (null != b) for (; null != c;) n = e[c], null != n && b(n), c = c == d ? null : a ? f[c] : g[c] } function d(a, b, d) { c(!0, a, b, d) } var e = {}, f = {}, g = {}, h =
    null, j = null; return {
        add: a, item: function (a) { return e[a] }, nextKey: function (a) { return f[a] }, prevKey: function (a) { return g[a] }, startKey: function () { return h }, endKey: function () { return j }, unshift: b, insertAfter: function (c, d, h) { if (e.hasOwnProperty(d)) throw "Duplicate segments are not supported!"; if (null == c) b(d, h); else { var j = f[c]; null == j ? a(d, h) : (e[d] = h, f[c] = d, f[d] = j, g[j] = d, g[d] = c) } }, remove: function (a) { var b = g[a], c = f[a]; null != b ? f[b] = c : h = c; null != c ? g[c] = b : j = b; delete e[a]; delete f[a]; delete g[a] }, iterate: d, iterateBack: function (a,
        b, d) { c(!1, a, b, d) }, empty: function () { e = {}; f = {}; g = {}; j = h = null }, toArray: function () { var a = []; d(function (b) { a.push(b) }); return a }, validate: function (a) {
            var b, c; for (b in e) if (e.hasOwnProperty(b) && (!f.hasOwnProperty(b) || !g.hasOwnProperty(b))) return null != a && (a.message = "Orphant key found!"), !1; if (!e.hasOwnProperty(h) || !e.hasOwnProperty(j)) return null != a && (a.message = "Start or end values are missing!"), !1; for (b in f) if (f.hasOwnProperty(b)) {
                if (!e.hasOwnProperty(b) || !g.hasOwnProperty(b)) return null != a && (a.message =
                "Orphant key found!"), !1; if ((c = f[b]) && !f.hasOwnProperty(c)) return null != a && (a.message = "Next key not found!"), !1
            } for (b in g) if (g.hasOwnProperty(b)) { if (!e.hasOwnProperty(b) || !f.hasOwnProperty(b)) return null != a && (a.message = "Orphant key found!"), !1; if ((c = g[b]) && !g.hasOwnProperty(c)) return null != a && (a.message = "Prev key not found!"), !1 } return !0
        }
    }
};
primitives.common.tree = function () {
    function a(a, b, c) { var e, g, h; if (null != d[b] && (b = f[b], null != b)) { g = 0; for (h = b.length; g < h && !(e = b[g], c.call(a, e, d[e], g, h - 1)) ; g += 1); } } function b(a) { var b = null; null != e[a] && (b = e[a]); return b } function c(a, b) { var c, d = a.length; for (c = 0; c < d; c += 1) if (a[c] == b) return a.splice(c, 1), d - 1; return d } var d = {}, e = {}, f = {}, g = {}, h = {}; return {
        loop: function (a, b) { var c; if (null != b) for (c in d) if (d.hasOwnProperty(c) && b.call(a, c, d[c])) break }, loopLevels: function (a, b, c) {
            var e = 0, g = [], n, p, r, s, q; switch (arguments.length) {
                case 2: p =
                b; break; case 3: n = b, p = c
            } if (null != p) { if (null == n) for (r in h) h.hasOwnProperty(r) && (g = g.concat(h[r])); else null != f[n] && (g = g.concat(f[n])); for (; 0 < g.length;) { r = []; s = 0; for (q = g.length; s < q; s += 1) switch (n = g[s], p.call(a, n, d[n], e)) { case 1: r = []; break; case 2: break; default: null != f[n] && (r = r.concat(f[n])) } g = r; e += 1 } }
        }, loopParents: function (a, b, c) { if (null != d[b] && null != c) for (; null != (b = e[b]) && !c.call(a, b, d[b]) ;); }, loopChildren: a, loopChildrenRange: function (a, b, c, e, g) {
            var h; if (null != d[b] && (b = f[b], null != b)) if (c < e) {
                c = Math.max(c,
                0); e = Math.min(e, b.length - 1); for (h = c; h <= e && !(c = b[h], g.call(a, c, d[c], h, NaN)) ; h += 1);
            } else { c = Math.min(c, b.length - 1); e = Math.max(0, e); for (h = c; h >= e && !(c = b[h], g.call(a, c, d[c], h, NaN)) ; h -= 1); }
        }, loopChildrenReversed: function (a, b, c) { var e, g, h; if (null != d[b] && (b = f[b], h = b.length - 1, null != b)) for (g = h; 0 <= g && !(e = b[g], c.call(a, e, d[e], g, h)) ; g -= 1); }, loopPostOrder: function (a, b) {
            var c = [], g, m, n; if (null != b) {
                for (g in h) h.hasOwnProperty(g) && (c = c.concat(h[g])); for (; 0 < c.length;) if (g = c[c.length - 1], g != m && null != (n = f[g])) for (g = n.length -
                1; 0 <= g; g -= 1) c.push(n[g]); else if (c.pop(), m = e[g], b.call(a, g, d[g], m, d[m])) break
            }
        }, loopPreOrder: function (a, b) { var c = [], g, m, n; if (null != b) { for (g in h) h.hasOwnProperty(g) && (c = c.concat(h[g])); for (; 0 < c.length;) { g = c[c.length - 1]; if (g != m && b.call(a, g, d[g], m, d[m])) break; if (g != m && null != (n = f[g])) for (g = n.length - 1; 0 <= g; g -= 1) c.push(n[g]); else c.pop(), m = e[g] } } }, zipUp: function (a, b, c, d) { var f, g; if (null != d) for (; null != b && null != c && b != c;) { f = e[b]; g = e[c]; if (d.call(a, b, f, c, g)) break; b = f; c = g } }, parentid: b, parent: function (a) {
            var b =
            null; null != e[a] && (b = d[e[a]]); return b
        }, adopt: function (a, b) { if (null != d[a] && null != d[b]) if (a != b) g.hasOwnProperty(b) && (c(h[g[b]], b) || delete h[g[b]], delete g[b]), e.hasOwnProperty(b) && (c(f[e[b]], b) || delete f[e[b]]), e[b] = a, null != f[a] ? f[a].push(b) : f[a] = [b]; else throw "Item cannot be parent of itself!"; else throw "Both parent and child should be in hierarchy!"; }, moveChildren: function (b, c) { null != d[b] && (null != d[c] && b != c) && null != f[b] && (a(this, b, function (a) { e[a] = c }), f[c] = null != f[c] ? f[c].concat(f[b]) : f[b], delete f[b]) },
        ...
        }, validate: function () { var a = !0, b; for (b in g) if (g.hasOwnProperty(b) && null != g[b]) { a = !1; break } return a }, BREAK: 1, SKIP: 2
    }
};
...
primitives.callout.Controller.prototype._createLayout = function () {
    this.m_panelSize = new primitives.common.Rect(0, 0, this.element.outerWidth(), this.element.outerHeight()); this.m_placeholder = jQuery("<div></div>"); this.m_placeholder.css({ position: "relative", overflow: "hidden", top: "0px", left: "0px", padding: "0px", margin: "0px" }); this.m_placeholder.css(this.m_panelSize.getCSS()); this.m_placeholder.addClass("placeholder"); this.m_placeholder.addClass(this.widgetEventPrefix); this.element.append(this.m_placeholder);
    this.m_graphics = primitives.common.createGraphics(this.options.graphicsType, this); this.options.actualGraphicsType = this.m_graphics.graphicsType; this.m_shape = new primitives.common.Callout(this.m_graphics)
...
primitives.connector.Controller.prototype._createLayout = function () {
    this.m_panelSize = new primitives.common.Rect(0, 0, this.element.outerWidth(), this.element.outerHeight()); this.m_placeholder = jQuery("<div></div>"); this.m_placeholder.css({ position: "relative", overflow: "hidden", top: "0px", left: "0px", padding: "0px", margin: "0px" }); this.m_placeholder.css(this.m_panelSize.getCSS()); this.m_placeholder.addClass("placeholder"); this.m_placeholder.addClass(this.widgetEventPrefix); this.element.append(this.m_placeholder);
    this.m_graphics = primitives.common.createGraphics(this.options.graphicsType, this); this.options.actualGraphicsType = this.m_graphics.graphicsType; this.m_shape = new primitives.common.Connector(this.m_graphics)
}; primitives.connector.Controller.prototype._cleanLayout = function () { null !== this.m_graphics && this.m_graphics.clean(); this.m_graphics = null; this.element.find("." + this.widgetEventPrefix).remove() };
...
primitives.connector.Controller.prototype._redraw = function () {
    var a = "orientationType connectorShapeType offset lineWidth color lineType labelSize".split(" "), b, c; this.m_graphics.activate("placeholder"); for (b = 0; b < a.length; b += 1) c = a[b], null != this.options[c] && (this.m_shape[c] = this.options[c]); this.m_shape.hasLabel = !primitives.common.isNullOrEmpty(this.options.label); this.m_shape.labelPlacementType = this.options.labelPlacementType; this.m_shape.labelTemplate = this._labelTemplate; this.m_shape.labelTemplateHashCode =
...
primitives.famdiagram.Config = function (a) {
    this.name = void 0 !== a ? a : "FamDiagram"; this.classPrefix = "famdiagram"; this.graphicsType = 0; this.actualGraphicsType = null; this.pageFitMode = 3; this.minimalVisibility = 2; this.orientationType = 0; this.verticalAlignment = 1; this.arrowsDirection = 0; this.groupByType = 2; this.elbowType = 3; this.elbowDotSize = 4; this.emptyDiagramMessage = "Diagram is empty."; this.items = []; this.annotations = []; this.highligtItem = this.cursorItem = null; this.selectedItems = []; this.hasSelectorCheckbox = 0; this.selectCheckBoxLabel =
...
primitives.famdiagram.ConnectorAnnotationConfig = function (a, b) {
    var c; this.annotationType = 0; this.zOrderType = 2; this.toItem = this.fromItem = null; this.connectorShapeType = 0; this.labelPlacementType = primitives.common.ConnectorLabelPlacementType.Between; this.offset = new primitives.common.Thickness(0, 0, 0, 0); this.lineWidth = 2; this.color = "#000000"; this.lineType = 0; this.selectItems = !0; this.label = null; this.labelSize = new primitives.common.Size(60, 30); switch (arguments.length) {
        case 1: for (c in a) a.hasOwnProperty(c) && (this[c] =
        a[c]); break; case 2: this.fromItem = a, this.toItem = b
    }
}; primitives.famdiagram.HighlightPathAnnotationConfig = function (a) { var b; this.annotationType = 2; this.items = []; this.selectItems = !1; switch (arguments.length) { case 1: if (null !== a) if (a instanceof Array) this.items = a; else if ("object" == typeof a) for (b in a) a.hasOwnProperty(b) && (this[b] = a[b]) } };
primitives.famdiagram.ItemConfig = function (a, b, c, d, e) {
    var f; this.id = null; this.parents = []; this.spouses = []; this.context = this.image = this.description = this.title = null; this.itemTitleColor = "#4169e1"; this.groupTitle = this.minimizedItemShapeType = null; this.groupTitleColor = "#4169e1"; this.isActive = !0; this.hasButtons = this.hasSelectorCheckbox = 0; this.templateName = null; this.showCallout = 0; this.label = this.calloutTemplateName = null; this.showLabel = 0; this.labelSize = null; this.labelOrientation = 3; this.labelPlacement = 0; switch (arguments.length) {
        case 1: for (f in a) a.hasOwnProperty(f) &&
        (this[f] = a[f]); break; case 5: this.id = a, this.parent = b, this.title = c, this.description = d, this.image = e
    }
...
primitives.famdiagram.Controller.prototype._virtualCreateOrgTree = function () {
    ...
    this.itemByChildrenKey = {}; this._orgPartners = {}; this._families = []; this._orgTree = primitives.common.tree(); this.maximumFamItemId = 0; this.maximumLevel = this.minimumLevel = null; if (0 < this.options.items.length) {
        c = []; a = 0; for (b = this.options.items.length; a < b; a += 1) d = this.options.items[a], null != d && (this._configs.add(d.parents, d.id, d), e = new primitives.famdiagram.FamilyItem({ id: d.id, itemConfig: d, isActive: d.hasOwnProperty("isActive") ? d.isActive : !0 }), this._logicalFamily.add(d.parents, e.id, e), f = e.itemConfig.spouses,
        ...
        this._addFakeChildrenForSpouses(this._logicalFamily, c); if (this._debug && !this._logicalFamily.validate()) throw "References are broken in family structure!"; this._logicalFamily.loopLevels(this, 1 == this.options.groupByType, function (a, b, c) { b.level = c }); this._logicalFamily.optimizeReferences(function () {
            q.maximumFamItemId += 1; return new primitives.famdiagram.FamilyItem({
        ...
        this.defaultItemConfig = new primitives.famdiagram.ItemConfig; k = 0; v = []; this._logicalFamily.loopRoots(this, function (a) { l = new primitives.famdiagram.Family(k); this._extractOrgChart(a, this._logicalFamily, u, l); this._families.push(l); v.push(l); k += 1 }); v.sort(function (a, b) { var c = a.items[0].level, d = b.items[0].level; return c != d ? c - d : b.items.length - a.items.length }); j = []; i = {}; if (0 < this._families.length) {
            f = primitives.common.graph(); a = 0; for (b = this._families.length; a < b; a += 1) {
                l = this._families[a]; c = 0; for (d = l.links.length; c <
                d; c += 1) e = l.links[c], g = this._logicalFamily.node(e.fromItem).familyId, h = this._logicalFamily.node(e.toItem).familyId, g != h && (f.addEdge(g, h, { weight: 0 }), f.edge(g, h).weight += 1), this._families[h].backLinks.push(new primitives.famdiagram.FamLink(e.toItem, e.fromItem))
            } for (; j.length < this._families.length;) {
                a = 0; for (b = v.length; a < b; a += 1) l = v[a], i.hasOwnProperty(l.id) || (s = f.getSpanningTree(l.id, function (a, b) { return a.weight - b.weight }), null != s.node(l.id) ? (s.loopPostOrder(this, function (a, b, c) {
                    var b = this._families[a],
                    d = this._families[c], e = [], f = this; null != c && (d.familyPriority += b.familyPriority); e = []; s.loopChildren(this, a, function (a) { e.push(a) }); e.sort(function (a, b) { return f._families[a].familyPriority - f._families[b].familyPriority }); s.arrangeChildren(a, e)
                }), s.loopPreOrder(this, function (a) { j.push(a); i[a] = !0 })) : (j.push(l.id), i[l.id] = !0))
            }
        } this.maximumFamItemId += 1; t = this._createOrgItem(this.maximumFamItemId, null, null, this.minimumLevel - 1, null); t.hideParentConnection = !0; t.hideChildrenConnection = !0; t.title = "internal root";
        ...
        b = this._getGrandChildren(); this._balanceOrgTree(this._orgTree, a, b)
    }
...
primitives.famdiagram.Controller.prototype._addFakeChildrenForSpouses = function (a, b) {
    var c, d, e, f, g, h, j, i; e = 0; for (f = b.length; e < f; e += 1) {
        g = b[e]; i = g.itemConfig.spouses.slice(0); h = 0; for (j = i.length; h < j; h += 1) c = [g.id, i[h]], this._logicalFamily.hasCommonChild(c) || (this.maximumFamItemId += 1, d = new primitives.famdiagram.FamilyItem({
            id: this.maximumFamItemId, isVisible: this._debug, isActive: !0, isLevelNeutral: !0, hideParentConnection: !0, hideChildrenConnection: !0, itemConfig: {
                title: "fake child #" + this.maximumFamItemId,
                description: "This is fake child keeps spouses together."
            }
        }), this._logicalFamily.add(c, d.id, d))
    }
};
primitives.famdiagram.Controller.prototype._removeLoops = function (a) {
    var b, c, d, e, f, g, h, j, i; b = a.clone(); a.loopTopo(this, function (a) { b.removeNode(a) }); if (b.hasNodes()) {
        e = 0; for (f = this.options.items.length; e < f; e += 1) if (c = this.options.items[e], null != b.node(c.id)) {
            i = []; b.loopParents(this, c.id, function (a) { i.push(a); return b.SKIP }); g = 0; for (h = i.length; g < h; g += 1) b.removeRelation(i[g], c.id), a.removeRelation(i[g], c.id); this.maximumFamItemId += 1; d = new primitives.famdiagram.FamilyItem({
                id: this.maximumFamItemId, isVisible: this._debug,
                isActive: !0, isLevelNeutral: !0, hideParentConnection: !0, hideChildrenConnection: !0, itemConfig: { title: "fake parent #" + this.maximumFamItemId, description: "This is fake parent item was created by loops reversal." }
            }); a.add([], d.id, d); a.adopt([d.id], c.id); g = 0; for (h = i.length; g < h; g += 1) this.maximumFamItemId += 1, c = new primitives.famdiagram.FamilyItem({
                id: this.maximumFamItemId, isVisible: this._debug, isActive: !0, isLevelNeutral: !0, hideParentConnection: !0, hideChildrenConnection: !0, itemConfig: {
                    title: "fake child #" + this.maximumFamItemId,
                    description: "This is fake child item was created by loops reversal."
                }
            }), a.add([d.id, i[g]], c.id, c); j = []; b.loopTopo(this, function (a) { j.push(a) }); g = 0; for (h = j.length; g < h; g += 1) b.removeNode(j[g])
        }
    }
};
primitives.famdiagram.Controller.prototype._addLabelAnnotations = function (a, b) {
    var c = primitives.common.graph(), d = {}, e, f, g, h, j = this; if (0 < b.length) {
        h = 0; for (e = b.length; h < e; h += 1) f = b[h], 3 == f.annotationType && (d.hasOwnProperty(f.fromItem) ? d[f.fromItem].push(f) : (d[f.fromItem] = [f], a.loopChildren(this, f.fromItem, function (b) { c.addEdge(f.fromItem, b, new primitives.famdiagram.EdgeItem(f.fromItem, f.fromItem, b, b)); return a.SKIP }), a.loopParents(this, f.fromItem, function (b) {
            c.addEdge(b, f.fromItem, new primitives.famdiagram.EdgeItem(b,
            b, f.fromItem, f.fromItem)); return a.SKIP
        }))); for (g in d) if (d.hasOwnProperty(g)) { e = d[g]; e.sort(function (a, b) { return b.toItems.length - a.toItems.length }); for (h = 0; h < e.length; h += 1) f = e[h], this._addLabelAnnotation(a, c, f.fromItem, f.toItems, function () { j.maximumFamItemId += 1; return new primitives.famdiagram.FamilyItem({ id: j.maximumFamItemId, isVisible: !0, isLevelNeutral: !0, isActive: !1, itemConfig: f }) }) }
    }
};
primitives.famdiagram.Controller.prototype._addLabelAnnotation = function (a, b, c, d, e) {
    var f, g = !0, h = null, j, i, k, l = []; i = 0; for (k = d.length; i < k; i += 1) if (j = d[i], f = b.edge(c, j), null != f) { if (null == h) h = f.getFar(j); else if (h != f.getFar(j)) { g = !1; break } l.push(f.getNear(j)) } else { g = !1; break } if (g && (e = e(), 1 == this.options.arrowsDirection ? (f = a.bundleParents, a = a.bundleChildren) : (f = a.bundleChildren, a = a.bundleParents), f(h, l, e.id, e) ? (e.levelGravity = 2, g = !0) : f(h, d, e.id, e) ? (e.levelGravity = 2, g = !0) : a(h, l, e.id, e) ? (e.levelGravity = 1,
...
primitives.famdiagram.Controller.prototype._balanceOrgTree = function (a, b, c) {
    var d, e, f, g, h, j, i, k, l, m, n; a.loopLevels(this, function (p, r) {
        var s = primitives.common.graph(), q = {}, t = null, u; i = []; a.loopChildren(this, r.id, function (c, f, g) {
            var i; null == t && (t = f); q[f.id] = {}; if (b.hasOwnProperty(f.id)) for (i in j = b[f.id], j) if (j.hasOwnProperty(i)) {
                m = j[i]; q[f.id][i] = {}; d = 0; for (e = m.length; d < e; d += 1) h = m[d], u = h.commonParent == r.id ? h.toParent : a.node(h.fromParent).childIndex < a.node(h.toParent).childIndex ? "__right__" : "__left__",
                f.id != u && (s.addEdge(f.id, u, { weight: 0 }), s.edge(f.id, u).weight += 1, null == q[f.id][i][u] && (q[f.id][i][u] = 0), q[f.id][i][u] += 1)
            } 0 < g && s.addEdge(f.id, t.id, { weight: 0 })
        }); if (null != t) { n = s.getGrowthSequence(function (a) { return a.weight }); 0 == n.length && (n = [t.id]); k = this._balanceItems(n, "__left__", "__right__", q, c); f = 0; for (g = k.length; f < g; f += 1) l = a.node(k[f]), l.childIndex = f, i.push(l.id) } a.arrangeChildren(r.id, i)
    })
};
primitives.famdiagram.Controller.prototype._balanceItems = function (a, b, c, d, e) {
    var f = [], g, h, j, i, k, l, m, n, p, r, s, q, t, u, v, x, w, z, G, C; h = new primitives.famdiagram.Slots; h.add(new primitives.famdiagram.Slot(b)); h.add(new primitives.famdiagram.Slot(null)); h.add(new primitives.famdiagram.Slot(c)); j = 0; h.loop(function (a) { j += 1; a.position = j }); for (g = 0; g < a.length; g += 1) if (i = a[g], i != b && i != c) for (w in p = n = m = l = k = null, h.loop(function (a) {
    var b, c, f, g; if (null == a.itemId) {
    u = e[i]; t = q = s = r = 0; for (b in a.crossings) a.crossings.hasOwnProperty(b) &&
    (u && null != u[b] && (r += a.crossings[b] * u[b]), t += a.crossings[b]); for (b in d[i]) if (d[i].hasOwnProperty(b)) for (c in f = d[i][b], f) f.hasOwnProperty(c) && (g = h.getSlot(c), null != g && (g.position < a.position ? (r += (a.left[b] || 0) - (g.left[b] || 0), q += Math.abs(g.balance + 1)) : (r += (a.right[b] || 0) - (g.right[b] || 0), q += Math.abs(g.balance - 1)), s += Math.abs(g.position - a.position))); if (null == l || l > r || l == r && (m > s || m == s && (n > q || n == q && p > t))) l = r, k = a, m = s, n = q, p = t
    }
    }), v = k.clone(), x = k.clone(), x.itemId = i, h.insertBefore(k, v), h.insertBefore(k, x), j =
    x.position = 0, h.loop(function (a) { var b, c; if (a.id != x.id) { c = e[i]; for (b in c) c.hasOwnProperty(b) && (a.left[b] = a.left[b] ? a.left[b] + c[b] : c[b]); j += 1; a.position = j } }, x), j = 0, h.backwardLoop(function (a) { var b, c; if (a.id != x.id) { c = e[i]; for (b in e[i]) e[i].hasOwnProperty(b) && (a.right[b] = a.right[b] ? a.right[b] + c[b] : c[b]); j -= 1; a.position = j } }, x), d[i]) if (d[i].hasOwnProperty(w)) for (G in z = d[i][w], z) z.hasOwnProperty(G) && (C = h.getSlot(G), null != C && (0 > C.position ? (C.balance += 1, x.balance -= 1, h.backwardLoop(function (a) {
        if (a.id !=
        x.id) if (a.id != C.id) a.crossings[w] = a.crossings[w] ? a.crossings[w] + z[G] : z[G]; else return !0
    }, x)) : (C.balance -= 1, x.balance += 1, h.loop(function (a) { if (a.id != x.id) if (a.id != C.id) a.crossings[w] = a.crossings[w] ? a.crossings[w] + z[G] : z[G]; else return !0 }, x)))); h.loop(function (a) { a = a.itemId; null != a && (a != b && a != c) && f.push(a) }); return f
};
...
primitives.famdiagram.Controller.prototype._extractOrgChart = function (a, b, c, d) {
    var e, f = [], g, h, a = this._logicalFamily.node(a), f = this._createOrgItem(a.id, null, d.id, a.level, a.itemConfig); f.hideParentConnection = !0; f.isVisible = a.isVisible; f.isActive = a.isActive; f.hideParentConnection = a.hideParentConnection; f.hideChildrenConnection = a.hideChildrenConnection; d.items.push(f); c[a.id] = !0; a.familyId = d.id; for (f = this._extractChildren(a, b, c, d) ; 0 < f.length;) {
        g = []; a = 0; for (e = f.length; a < e; a += 1) h = f[a], g = g.concat(this._extractChildren(h,
        b, c, d)); f = g
    }
};
primitives.famdiagram.Controller.prototype._extractChildren = function (a, b, c, d) {
    var e = [], f = {}, g = null, h = null, j; 1 == b.countChildren(a.id) && (g = b.firstChild(a.id)); null != this.itemByChildrenKey[g] ? (h = this.itemByChildrenKey[g], null == this._orgPartners[h.id] && (this._orgPartners[h.id] = []), this._orgPartners[h.id].push(a.id), d.links.push(new primitives.famdiagram.FamLink(a.id, g))) : (null != g && (this.itemByChildrenKey[g] = a), b.loopChildren(this, a.id, function (g, h) {
        var l = null; c[h.id] || (1 == b.countChildren(g) && (l = b.firstChild(g)),
        null != f[l] ? (j = this._createOrgItem(h.id, f[l].id, d.id, h.level, h.itemConfig), j.itemType = 6) : (null != l && (f[l] = h), e.push(h), j = this._createOrgItem(h.id, a.id, d.id, h.level, h.itemConfig)), j.hideParentConnection = h.hideParentConnection, j.hideChildrenConnection = h.hideChildrenConnection, j.isVisible = h.isVisible, j.isActive = h.isActive, d.items.push(j), c[h.id] = !0, h.familyId = d.id); return b.SKIP
    })); return e
};
...
primitives.famdiagram.Controller.prototype._resortItemsBylevels = function (a) {
    var b = [], c = null, d = null, e, f, g; a.loop(this, function (a, e) { e.originalLevel = e.level; e.level = null; null != e.originalLevel && (b[e.originalLevel] || (b[e.originalLevel] = {}), b[e.originalLevel][a] = e, c = null != c ? Math.min(e.originalLevel, c) : e.originalLevel, d = null != d ? Math.max(e.originalLevel, d) : e.originalLevel) }); e = 0; for (f = c; f <= d; f += 1) g = b[f], e = this._setLevelsForItems(g, a, e, f + 1); a.loopTopoReversed(this, function (b, c) {
        var d; 2 == c.levelGravity && (d =
...
primitives.famdiagram.Controller.prototype._fillInItems = function (a, b) {
    var c; a.loop(this, function (d, e) { for (var f = !0, g; f;) f = !1, g = [], a.loopParents(this, d, function (b, c) { e.level - 1 > c.level && g.push(b); return a.SKIP }), 1 < g.length && (c = b(e), c.level = e.level - 1, a.bundleParents(d, g, c.id, c), f = !0, d = c.id, e = c) }); a.loop(this, function (d, e) {
        for (var f = !0, g, h = !0; f;) f = !1, g = [], a.loopChildren(this, d, function (b, c) { e.level + 1 < c.level ? g.push(b) : h = !1; return a.SKIP }), 0 < g.length && (c = b(e), c.level = e.level + 1, h && (c.hideParentConnection =
...
primitives.orgdiagram.Config = function (a) {
    this.name = void 0 !== a ? a : "OrgDiagram"; this.classPrefix = "orgdiagram"; this.graphicsType = 0; this.actualGraphicsType = null; this.pageFitMode = 3; this.minimalVisibility = 2; this.horizontalAlignment = this.orientationType = 0; this.verticalAlignment = 1; this.elbowType = this.connectorType = this.arrowsDirection = 0; this.elbowDotSize = 4; this.emptyDiagramMessage = "Diagram is empty."; this.items = []; this.annotations = []; this.highligtItem = this.cursorItem = null; this.selectedItems = []; this.hasSelectorCheckbox =
...
primitives.orgdiagram.Controller.prototype._virtualCreateOrgTree = function () {
    var a, b, c, d, e, f, g, h, j, i, k; this._configs = primitives.common.tree(); this._orgTree = primitives.common.tree(); if (null != this.options.items && 0 < this.options.items.length) {
        j = "title description image itemTitleColor groupTitle groupTitleColor isVisible isActive hasSelectorCheckbox hasButtons itemType adviserPlacementType childrenPlacementType templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement minimizedItemShapeType".split(" "); i =
...
primitives.orgdiagram.Template = function (a, b) {
    var c; this.widgetEventPrefix = "orgdiagram"; this.templateConfig = a; for (c in b) b.hasOwnProperty(c) && (this[c] = a.hasOwnProperty(c) ? a[c] : b[c]); this.minimizedItemCornerRadius = null === a.minimizedItemCornerRadius ? this.minimizedItemSize.width / 2 : a.minimizedItemCornerRadius; this.itemTemplateHashCode = this.dotHighlightTemplate = this.dotHighlightTemplateHashCode = null; this.itemTemplateRenderName = "onItemRender"; this.highlightTemplateHashCode = null; this.highlightTemplateRenderName =
...
primitives.orgdiagram.Template.prototype._getDefaultItemTemplate = function () {
    ...
    b.append(a); return b.wrap("<div>").parent().html()
...
primitives.orgdiagram.TreeItem.prototype.setActualSize = function (a, b) {
    var c = primitives.common; this.actualVisibility = 0 === this.visibility ? a.currentvisibility : this.visibility; switch (this.actualVisibility) {
        case 1: this.actualSize = new c.Size(this.template.itemSize); this.contentPosition = new c.Rect(0, 0, this.actualSize.width, this.actualSize.height); this.isCursor && (this.actualSize.height += this.template.cursorPadding.top + this.template.cursorPadding.bottom, this.actualSize.width += this.template.cursorPadding.left +
        this.template.cursorPadding.right, this.contentPosition.x = this.template.cursorPadding.left, this.contentPosition.y = this.template.cursorPadding.top); this.actualHasSelectorCheckbox && (this.actualSize.height += b.checkBoxPanelSize); this.actualHasButtons && (this.actualSize.width += b.buttonsPanelSize); if (this.actualHasGroupTitle = !c.isNullOrEmpty(this.orgItem.groupTitle)) this.actualSize.width += b.groupTitlePanelSize, this.contentPosition.x += b.groupTitlePanelSize; break; case 2: this.actualSize = new c.Size(this.template.minimizedItemSize);
            break; case 3: case 4: this.actualSize = new c.Size
    } switch (b.orientationType) { case 2: case 3: this.actualSize.invert() }
};
...
primitives.shape.Controller.prototype._redraw = function () {
    ...
    this._labelTemplateHashCode; this.m_shape.panelSize = new primitives.common.Size(this.m_panelSize.width, this.m_panelSize.height); this.m_shape.draw(this.options.position)
