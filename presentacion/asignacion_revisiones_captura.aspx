<%@ Page Title="Captura Revisiones" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="asignacion_revisiones_captura.aspx.cs" Inherits="presentacion.asignacion_revisiones_captura" %>
        ...
        <div class="container-fluid">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="ddlEntrega" EventName="SelectedIndexChanged" />
                    <asp:AsyncPostBackTrigger ControlID="ddlPrepara" EventName="SelectedIndexChanged" />
                    ...
                    <asp:AsyncPostBackTrigger ControlID="txtFiltroPrep" EventName="TextChanged" />
                    <asp:AsyncPostBackTrigger ControlID="txtFiltroEntrega" EventName="TextChanged" />
                    <asp:AsyncPostBackTrigger ControlID="cbxSinSucursal" EventName="CheckedChanged" />
                    <asp:AsyncPostBackTrigger ControlID="lnkRealacionas" EventName="Click" />
                    ...
                    <div class="Bordeado">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <asp:TextBox ID="txtFiltrorev" onkeypress="return isNumber(event);" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtFiltrorev_TextChanged" placeholder="Buscar"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <asp:LinkButton ID="lnkRealacionas" OnClick="lnkRealacionas_Click" runat="server" CssClass="btn btn-success btn-block">Asignar a Todo <i class="fa fa-plus-circle"></i></asp:LinkButton>
                                </div>
                            </div>
                        </div>
                        <asp:Panel ID="PanelContent" Visible="true" runat="server">
                            <h4><i class="fa fa-thumbs-o-up"></i>&nbsp;Seleccione el Puesto que Prepara <small>Este puesto estara encargado de preparar </small></h4>
                            <div class="row">
                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <asp:DropDownList ID="ddlPrepara" OnSelectedIndexChanged="ddlPrepara_SelectedIndexChanged" runat="server" CssClass="form-control" AutoPostBack="true">
                                        </asp:DropDownList>
                                        <asp:Label ID="lblPrepara" CssClass="label label-danger" runat="server" Text="Seleccione un Puesto" Visible="false"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <asp:TextBox ID="txtFiltroPrep" onkeypress="return isNumber(event);" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtFiltroPrep_TextChanged" placeholder="Buscar"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <h4><i class="fa fa-truck"></i>&nbsp;Seleccione el Puesto que Entrega <small>Este puesto estara encargado de entregar </small></h4>
                            <div class="row">
                                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <asp:DropDownList ID="ddlEntrega" OnSelectedIndexChanged="ddlEntrega_SelectedIndexChanged" runat="server" CssClass="form-control" AutoPostBack="true">
                                        </asp:DropDownList>
                                        <asp:Label ID="lblEntrega" CssClass="label label-danger" runat="server" Text="Seleccione un Puesto" Visible="false"></asp:Label>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <asp:TextBox ID="txtFiltroEntrega" onkeypress="return isNumber(event);" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtFiltroEntrega_TextChanged" placeholder="Buscar"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </asp:Panel>
