...
{
    public partial class pre_empleados_pendientes_alta : System.Web.UI.Page
    {
        ...
        private void Cargaro()
        {
            try
            {
                ...
                DataSet ds = componente.sp_pre_empleados_pendientes_alta();
            ...
            switch (e.CommandName)
            {
                ...
                case "RegenerarGUID":
                    ...
                    else
                    {
                        ...
                        DataTable dt_correos_reclu = funciones.CorreoReclutador(idc_pre);
