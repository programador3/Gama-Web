<%@ Page Title="Captura" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="reportes_tipo_captura.aspx.cs" Inherits="presentacion.reportes_tipo_captura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    <h2 class=" page-header">Captura de Reportes
        <span><input type="button" runat="server" id="btncrr" visible="false" value="Cerrar Ventana" onclick="window.close();" class="btn btn-danger" /></span>
            ...
            <div class="row">
                <div class=" col-lg-12" runat="server" id="div_detalles">
                    <h4><i class="fa fa-list-alt"></i>&nbsp;Descripción del Reporte</h4>
                    ...
                    <h4><strong><i class="fa fa-question-circle" aria-hidden="true"></i>&nbsp;Aplica a Todos los Puestos? </strong>
                    </h4>
                    <asp:CheckBox ID="cbxeditable" AutoPostBack="true" CssClass="radio3 radio-check radio-info radio-inline"
                        Text="El Reporte Aplica a Todos" runat="server" OnCheckedChanged="cbxeditable_CheckedChanged" />
                </div>
                <div class="col-lg-12" id="div_puestos" runat="server">
                    ...
                    <asp:TextBox ID="txtbuscar" onfocus="$(this).select();" placeholdeR="Buscar Puestos | Empleados" AutoPostBack="true" CssClass=" form-control"
                        runat="server" OnTextChanged="txtbuscar_TextChanged"></asp:TextBox>
                    <br />
                    <div style="padding: 20px; border: 1px solid gray;">
                        <h4 style="text-align: center;"><strong>Listado&nbsp;<i class="fa fa-list" aria-hidden="true"></i></strong>
                            <span>
                                <asp:LinkButton ID="lnksele" CssClass="btn btn-default" runat="server" OnClick="lnksele_Click">Seleccionar Todos los Mostrados</asp:LinkButton></span>
                        </h4>
                        <div style="background-color: white; width: 100%; height: 200px; overflow-y: auto">
                            <asp:UpdatePanel ID="updafefefe" runat="server" UpdateMode="always">
                                <ContentTemplate>
