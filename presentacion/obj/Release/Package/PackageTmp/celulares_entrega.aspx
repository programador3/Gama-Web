<%@ Page Title="Celulares" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="celulares_entrega.aspx.cs" Inherits="presentacion.celulares_entrega" %>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="btn-group">
                        ...
                        <asp:LinkButton ID="lnkRevision" runat="server" class="btn btn-link" OnClick="lnkRevision_Click">Entrega <i class="fa fa-check-square-o"></i></asp:LinkButton>
                    </div>
                </div>
                <div class="col-lg-8">
