...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
            ...
            <div class="table table-responsive" style="font-size: 12px;">
                <asp:GridView Style="text-align: center;" ID="gridhallazgos" DataKeyNames="idc,observaciones, sucursal,correo_capturo,reviso, usuario_sol,tipo,tipoh,idc_revsuccheck" AutoGenerateColumns="false" CssClass="gvv table table-responsive table-bordered table-condensed" runat="server" OnRowCommand="gridhallazgos_RowCommand">
                    <Columns>
                        ...
                        <asp:BoundField DataField="fecha_string" HeaderText="Fecha" HeaderStyle-Width="120px"></asp:BoundField>
    ...
    <div class="modal fade modal-primary" id="myModalcamb" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="text-align: center;">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4><strong>Cambiar Usuario Solución</strong></h4>
                </div>
                <div class="modal-body">
                    <div class="row" style="text-align: center;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        ...
                        <div class="col-lg-12">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="always">
                                <ContentTemplate>
                                    <asp:TextBox AutoPostBack="true" OnTextChanged="buscarusuario_SelectedIndexChanged" ID="txtbuscarusuario" Width="70%" CssClass="form-control2" runat="server" placeholder="Buscar"></asp:TextBox>
                                    <asp:LinkButton ID="lnkbuscar" OnClick="buscarusuario_SelectedIndexChanged" CssClass="btn btn-success" Width="28%" runat="server">Buscar</asp:LinkButton>
                                    <br />
                                    <br />
                            ...
                            <br />
                            <br />
                            <div class="alert fresh-color alert-danger alert-dismissible" role="alert" runat="server" id="diverror_cam" visible="false">
                                <strong>ERROR</strong>
                                <asp:Label ID="lblerror_camb" runat="server" Text="Label"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <input id="No2" class="btn btn-danger btn-block" onclick="ModalClose();" value="Cerrar" />
                    </div>
                </div>
            </div>
        </div>
