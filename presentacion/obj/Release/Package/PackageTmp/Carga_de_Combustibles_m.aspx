            ...
            <div style="width:100%;">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                     ...
                     <div class="col-lg-12 col-sm-12">
                        <h4><strong><i class="fa fa-user" aria-hidden="true"></i>&nbsp; <asp:HyperLink ID="linkChofer" runat="server" ForeColor="Navy">Chofer</asp:HyperLink></strong></h4>
                          ...
                          <asp:TextBox ID="txtbchofer" runat="server" AutoPostBack="True" 
                                        ...
                                        ontextchanged="TextBox2_TextChanged" placeholdeR="Buscar"
                                       ></asp:TextBox>   
                    </div>
                     <div class="col-lg-12 ">
                        <h4><strong><asp:Label ID="Label8" runat="server" Text="Cantidad de Litros"></asp:Label></strong></h4>
                     ...
                     <div class="col-lg-12">
                        <h4><strong> <asp:Label ID="Label6" runat="server" Text="Kilometraje Actual:"></asp:Label></strong></h4>
                         <asp:TextBox ID="txtkmactual" runat="server" Width="100%"   TextMode="Number"  onkeypress="return validarEnteros(event);"
                                        CssClass="form-control"></asp:TextBox>
                    </div>
                    
                     <div class="col-lg-12">
                        <h4><strong><asp:Label ID="Label3" runat="server" Text="Kilometraje Anterior: "></asp:Label></strong></h4>
                     ...
                     <div class="col-lg-12">
                        <h4><strong><asp:Label ID="Label4" runat="server" Text="Rendimiento Anterior: "></asp:Label></strong></h4>
                     ...
                     <div class="col-lg-12">
                        <h4><strong> <asp:Label ID="Label5" runat="server" Text="Litros Anterior: "></asp:Label></strong></h4>
                     ...
                     <div class="col-lg-12">
                        <h4><strong> <asp:Label ID="Label7" runat="server" Text="Distancia:"></asp:Label></strong></h4>
                           <asp:TextBox ID="txtdistancia" runat="server" Enabled="False" Width="100%" 
                                        CssClass="form-control"></asp:TextBox>
                    </div>
                    
                     <div class="col-lg-12">
                        <h4><strong><asp:Label ID="Label9" runat="server" Text="Rendimiento Actual:"></asp:Label></strong></h4>
                     ...
                     <div class="col-lg-12">
                        <h3><strong><asp:Label ID="lblaltor" runat="server" ForeColor="#009999" style="display:none;" 
                    ...
                    <div class="col-lg-12">
                        <asp:Panel ID="Panel1" runat="server" ForeColor="Black"
                            ...
                            <div class="col-lg-12">
                                <h4><strong> <asp:Label ID="Label12" runat="server" Text="Distancia Recorrida:"
                                          ></asp:Label></strong></h4> <asp:TextBox ID="txtdistanciarecorrida" runat="server" Enabled="False" TextMode="Number"
                                            Width="100%"  onkeypress="return validarEnteros(event);"
                                            CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-lg-12">
                                <h4><strong>
                                    <asp:Label ID="Label11" runat="server" Text="Combustible Utilizado:"
                                        ></asp:Label></strong></h4>
                            ...
                            <div class="col-lg-12">
                                <h4><strong> <asp:Label ID="Label13" runat="server" Text="Tiempo RELENTI:"></asp:Label></strong></h4> <asp:TextBox ID="txttiemporelenti" runat="server" Enabled="False" Width="100%"
                                            CssClass="form-control">00:00</asp:TextBox>
                            </div>
                            <div class="col-lg-12">
                                <h4><strong> <asp:Label ID="Label17" runat="server" Text="Rendimiento:"></asp:Label></strong></h4><asp:TextBox ID="txtrendimientopc" runat="server" Enabled="False" Width="100%"
                                            CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-lg-12">
                                <h4><strong>  <asp:Label ID="Label18" runat="server" Text="Combustible Utilizado en RELENTI:"
                                            ></asp:Label></strong></h4> <asp:TextBox ID="txtutilizadorelenti" runat="server" Enabled="False" Text=""
                                            Width="100%"
                                            CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-lg-12">
                                <h4><strong> <asp:Label ID="Label19" runat="server" ForeColor="Red" Text="FALTANTE:"></asp:Label></strong></h4>
                    ...
                    <div class="col-lg-12">
                     ...
                     <div class="col-lg-12">
                         <asp:CheckBox ID="chkreportebc" runat="server" 
                            ...
                            <br />                           
                        <h4><strong> <asp:Label ID="lblobservaciones" runat="server" style="display:none" 
                     ...
                     <div class="col-lg-12">
                        <h3><strong>  <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Navy" 
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row" style="text-align: center;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <h4><label id="content_modalf"></label></h4>
