<%@ Page Title="Listado de Tareas" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="tareas_listado.aspx.cs" Inherits="presentacion.tareas_asignadas_listado" %>
                        ...
                        <div class="card-header" style="background-color: #22A7F0; color: white;">
                            <div class="card-title" style="background-color: #22A7F0; color: white;">
                                <div class="title" style="background-color: #22A7F0; color: white;">
                                    <h3 style="background-color: #22A7F0; color: white;">Tareas Pendientes <small style="background-color: #22A7F0; color: white;" id="total_tareas" runat="server">
                        ...
                        <div class="card-body" id="TAREAS_IND" runat="server" visible="false">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <asp:TextBox ID="txt1" runat="server" TextMode="SingleLine" CssClass="form-control" AutoPostBack="true" OnTextChanged="txt1_TextChanged" placeholder="Buscar"></asp:TextBox>
                                <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-primary btn-block" OnClick="LinkButton2_Click">Buscar <i class="fa fa-search"></i></asp:LinkButton>
                               
                                </div>
                            </div>
                            <h3 style="text-align: center" id="notareas" runat="server" visible="false">No tiene Tareas Pendientes <i class="fa fa-thumbs-o-up" aria-hidden="true"></i></h3>
