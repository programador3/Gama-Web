<%@ Page Title="Revisiones" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="revisiones_preparacion.aspx.cs" Inherits="presentacion.revisiones_preparacion" %>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <asp:Button ID="btnAceptar" runat="server" Text="Confirmar" CssClass="btn btn-primary btn-block" OnClick="btnAceptar_Click" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
