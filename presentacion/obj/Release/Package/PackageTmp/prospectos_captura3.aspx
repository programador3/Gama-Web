...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    <div class="row">
        <div class="col-xs-12">
            <h1>
                <asp:HiddenField ID="rutaoculta" runat="server" />
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-xs-12">
                    <h4 class="control-label obligado"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;Contacto
                        <a href="ayuda/captura_de_prospectos.pdf" target="_blank" title="ayuda" class="obligado" id="informacionadd">(Ver mas Información)</a> </h4>
