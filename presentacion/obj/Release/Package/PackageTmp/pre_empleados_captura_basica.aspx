<%@ Page Title="Captura de Informacion" Language="C#" MasterPageFile="~/Global.Master" AutoEventWireup="true" CodeBehind="pre_empleados_captura_basica.aspx.cs" Inherits="presentacion.pre_empleados_captura_basica" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <asp:Panel ID="Panel_Personal" CssClass="panel panel-info fresh-color" runat="server">
                        ...
                        <div class="panel-body">
                                            ...
                                            <div id="partupload" runat="server" visible="true">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon" style="color: #fff; background-color: #22A7F0;">
                                                        <asp:LinkButton ID="lnkAgregarFotoPerfil" Style="color: #fff; background-color: #22A7F0;" runat="server" OnClick="lnkAgregarFotoPerfil_Click">Agregar Foto <i class="fa fa-plus-circle"></i></asp:LinkButton>
                                                    </span>
                                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 Ocultar">
                                    <div class="form-group">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon" style="color: #fff; background-color: #22A7F0;"><i class="fa fa-search"></i></span>
                    ...
                    <asp:Panel ID="PanelDatosLaborales" Visible="false" CssClass="panel panel-green fresh-color" runat="server">
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="border: 1px solid #000000;">
                                                    ...
                                                    <div class="col-lg-1 col-md-2 col-sm-12">
                                                        <h4><strong><i class="fa fa-calendar"></i>&nbsp;<%#Eval("dia") %></strong></h4>
                                                    </div>
                                                    <div class="col-lg-1 col-md-2 col-sm-12">
                                                        <div class="form-group">
                                                            <asp:CheckBox ID="cbxLaborables" AutoPostBack="true" CssClass="radio3 radio-check radio-info radio-inline" Text="Dia Laborable" OnCheckedChanged="cbxLaborables_CheckedChanged" Checked="true" runat="server" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-1 col-md-2 col-sm-12">
                                                        <div class="form-group">
                                                            <asp:CheckBox ID="cbxDescanso" AutoPostBack="true" CssClass="radio3 radio-check radio-info radio-inline" Text="Descanso" runat="server" />
                                                        </div>
                                                    </div>
                    ...
                    <asp:Panel ID="PanelDFamiliares" Visible="false" runat="server">
                        <div class="panel panel-danger fresh-color">
                            <div class="panel-heading" style="text-align: center;">
                            ...
                            <div class="panel-body">
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="col-lg-12" style="text-align: right;">
                                            <h4><strong>Formulario 3 de 4</strong></h4>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                    ...
                    <asp:Panel ID="PanelDConact" runat="server" Visible="false">
                        <div class="panel panel-warning fresh-color">
                            <div class="panel-heading" style="text-align: center;">
