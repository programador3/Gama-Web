...
{
    public partial class OC_Digitales_Pendientes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                cargar_combo_oc_cliente(Convert.ToInt32(funciones.de64aTexto(Request.QueryString["idc_cliente"])));
