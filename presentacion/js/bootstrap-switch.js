        ...
        return $.fn.bootstrapSwitch.defaults = {
            ...
            onInit: function () {
                if ($(this).is(':checked')) {
                    ...
                    if ($('#btnNew').hasClass('borrador')) {
                        $('#btnNew').addClass('produccion');
                        $('#btnNew').removeClass('borrador');
                    }
                    if ($('#panel-head1').hasClass('p-borrador')) {
                    ...
                    if ($('#btnNew').hasClass('produccion')) {
                        $('#btnNew').addClass('borrador');
                        $('#btnNew').removeClass('produccion');
                    }
                    if ($('#panel-head1').hasClass('p-produccion')) {
            ...
            onSwitchChange: function () {
                if ($(this).is(':checked')) {
                    window.location = 'perfiles.aspx?sborrador=0';
                }
                else {
                    window.location = 'perfiles.aspx?sborrador=1';
                }
            }
        };
